import{G as e,H as t,L as n,N as r,R as i,_ as a,a as o,c as s,d as c,g as l,h as u,i as d,l as f,m as p,n as m,o as h,q as g,s as _,t as v,u as y,v as b,x,z as S}from"./rich-text-Dh1VI6G_.js";function C(){return{lightbox:document.getElementById(`imgLightbox`),lightboxImg:document.getElementById(`imgLightboxImg`),closeBtn:document.getElementById(`imgLightboxClose`),backdrop:document.getElementById(`imgLightboxBackdrop`),openBtn:document.getElementById(`imgLightboxOpenBtn`)}}function w(){let{lightbox:e}=C();return!!(e&&e.classList.contains(`open`))}function T(e){let{lightbox:t,lightboxImg:n,openBtn:r}=C();!t||!n||!e||(n.classList.remove(`is-tall`),n.src=e,r&&(r.href=e),t.classList.add(`open`),t.setAttribute(`aria-hidden`,`false`),document.body.style.overflow=`hidden`,n.onload=function(){n.naturalHeight/n.naturalWidth>1.2&&n.classList.add(`is-tall`)})}function E(){let{lightbox:e,lightboxImg:t}=C();!e||!t||(e.classList.remove(`open`),e.setAttribute(`aria-hidden`,`true`),document.body.classList.contains(`modal-open`)||(document.body.style.overflow=``),t.src=``,t.classList.remove(`is-tall`))}function D(){let{lightbox:e,closeBtn:t,backdrop:n}=C();e&&(document.addEventListener(`click`,e=>{let t=e.target.closest(`.lightbox-trigger`);!t||!t.dataset.lightboxSrc||(e.preventDefault(),e.stopPropagation(),T(t.dataset.lightboxSrc))}),t&&t.addEventListener(`click`,E),n&&n.addEventListener(`click`,E),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&w()&&(e.stopImmediatePropagation(),E())},!0),window.openImageLightbox=T,window.closeImageLightbox=E,window.isImageLightboxOpen=w)}a(`student`);var O=new Set([`card_view`,`detail_open`,`link_click`,`pdf_open`,`share_click`,`category_click`,`resource_open`]);function k(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function A(){let e=navigator.userAgent;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)?`mobile`:`desktop`}function j(t,n={}){if(!O.has(t)||x===void 0)return Promise.resolve();let i={action:t,createdAt:g(),dayKey:k(),source:`student`,device:A(),contentType:n.contentType||(t===`category_click`?`category`:`post`)};return n.postId&&(i.postId=String(n.postId).slice(0,160)),n.category&&(i.category=String(n.category).slice(0,80)),r(e(x,`analyticsEvents`),i).catch(e=>{console.debug(`Student analytics skipped:`,e&&e.code?e.code:e)})}window.trackStudentEvent=j;var M=[];function N(e){return[...M,...e||[]]}var P={immigration:{labelEn:`Immigration`,labelEs:`Inmigración`,icon:`globe`,color:`#0d9488`},jobs:{labelEn:`Jobs`,labelEs:`Empleos`,icon:`briefcase`,color:`#24498f`},housing:{labelEn:`Housing`,labelEs:`Vivienda`,icon:`home`,color:`#df6b4a`},health:{labelEn:`Health`,labelEs:`Salud`,icon:`heart`,color:`#df477f`},food:{labelEn:`Food`,labelEs:`Comida`,icon:`food`,color:`#2f934f`},family:{labelEn:`Child Care`,labelEs:`Cuidado de niños`,icon:`family`,color:`#c99035`},esol:{labelEn:`English class`,labelEs:`Inglés`,icon:`abc`,color:`#8050d1`},hse:{labelEn:`GED / HSE`,labelEs:`Equivalencia escolar`,icon:`abc`,color:`#2563eb`},college:{labelEn:`College & Careers`,labelEs:`Universidad y carreras`,icon:`graduation`,color:`#0a1d3a`},"legal-aid":{labelEn:`Legal Help`,labelEs:`Ayuda legal`,icon:`scale`,color:`#7c3aed`},money:{labelEn:`Financial Help`,labelEs:`Ayuda financiera`,icon:`money`,color:`#1fa77e`},announcement:{labelEn:`Announcements`,labelEs:`Anuncios`,icon:`megaphone`,color:`#317dea`}},F=[`immigration`,`jobs`,`housing`,`health`,`food`],I=[`jobs`,`immigration`,`housing`,`health`,`food`,`family`,`hse`,`college`,`legal-aid`,`money`],L={all:{icon:`✨`,title:`Main Feed`,description:`New help, classes, jobs, and community support from your advisors.`,chips:[`New`,`Free help`,`This week`]},housing:{icon:`🏠`,title:`Housing Help`,description:`Find apartments, shelters, rent help, and housing support.`,chips:[`Emergency Housing`,`Apartments`,`Rent Help`,`Tenant Rights`]},job:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},jobs:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},immigration:{icon:`🌎`,title:`Immigration Help`,description:`Find legal help, citizenship support, and trusted local organizations.`,chips:[`Citizenship`,`Legal Help`,`Know Your Rights`,`Green Card`]},health:{icon:`❤️`,title:`Health Support`,description:`Find clinics, health information, mental health support, and care nearby.`,chips:[`Clinics`,`Mental Health`,`Insurance`,`Urgent Help`]},food:{icon:`🥕`,title:`Food Help`,description:`Find food pantries, meal programs, and grocery help for families.`,chips:[`Food Pantry`,`Meals`,`Delivery`,`Family Help`]},esol:{icon:`📘`,title:`Free Classes`,description:`Find English classes, adult education, GED, and student support.`,chips:[`English Class`,`GED`,`Conversation`,`Career English`]},college:{icon:`🎓`,title:`College Pathways`,description:`Find college, GED, certificates, and next-step education support.`,chips:[`GED`,`Certificates`,`Financial Aid`,`College Help`]},money:{icon:`💵`,title:`Money Help`,description:`Find financial coaching, benefits, tax help, and low-cost support.`,chips:[`Benefits`,`Tax Help`,`Budgeting`,`Free Support`]},childcare:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},family:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},training:{icon:`🧰`,title:`Training Posts`,description:`See advisor posts about workshops, skills training, certificates, and programs.`,chips:[`Workshops`,`Certificates`,`Career Skills`,`Programs`]},"career-fair":{icon:`📍`,title:`Career Fairs`,description:`Find hiring events, job fairs, and places to meet employers.`,chips:[`Hiring Events`,`Employers`,`Resume`,`Interviews`]},announcement:{icon:`📢`,title:`Announcements`,description:`School news, reminders, and general updates from your advisors.`,chips:[`School News`,`Reminders`,`Updates`,`Events`]}},R={shield:`
    ...
    <article class="pc ${p} ${i?`pc--expired`:``}" id="bulletin-${e.id}" data-bulletin-id="${e.id}" onclick="${f}" role="button" tabindex="0" style="cursor:pointer">
      ...
      <div class="pc__body">
        ...
        `}expandBulletinDateItems(e){if(e.dateType===`sessions`){let t=this.getBulletinEventSessions(e);return t.map((n,r)=>{let i=this.parseDateOnly(n.date);return i?{bulletin:e,rawDate:n.date,date:i,kind:`event`,session:n,label:this.getDatesListLabel(e,i,`event`,{sessionIndex:r+1,sessionTotal:t.length,session:n})}:null}).filter(Boolean)}let t=this.getDatesListItem(e);return t?[t]:[]}getDatesListItem(e){let t=``,n=`date`;if(e.dateType===`deadline`&&e.eventDate?(t=e.eventDate,n=`deadline`):e.dateType===`event`&&e.eventDate?(t=e.eventDate,n=`event`):e.dateType===`range`&&e.startDate?(t=e.startDate,n=`start`):e.eventDate?(t=e.eventDate,n=`event`):e.startDate?(t=e.startDate,n=`start`):e.deadline&&(t=e.deadline,n=`deadline`),!t)return null;let r=this.parseDateOnly(t);return r?{bulletin:e,rawDate:t,date:r,kind:n,label:this.getDatesListLabel(e,r,n)}:null}parseDateOnly(e){if(!e)return null;if(e instanceof Date)return e;if(typeof e.toDate==`function`)return e.toDate();let t=String(e),n=t.includes(`T`)?new Date(t):new Date(`${t}T12:00:00`);return Number.isNaN(n.getTime())?null:n}getDatesListLabel(e,t,n,r={}){let i=this.getLocale(),a=this.getCurrentLang()===`ES`,o=t.toLocaleDateString(i,{weekday:`short`,month:`short`,day:`numeric`}),s=t.toLocaleDateString(i,{weekday:`long`,month:`short`,day:`numeric`}),c=r.session?this.formatTimeRange(r.session.startTime,r.session.endTime):this.formatTimeRange(e.startTime,e.endTime);return n===`deadline`?a?`Postular antes del ${o}`:`Apply by ${o}`:n===`start`?a?`Comienza el ${s}${c?` · ${c}`:``}`:`Starts ${o}${c?` · ${c}`:``}`:r.sessionTotal>1?a?`${s} (Sesión ${r.sessionIndex} de ${r.sessionTotal})${c?` · ${c}`:``}`:`${s} (Session ${r.sessionIndex} of ${r.sessionTotal})${c?` · ${c}`:``}`:`${s}${c?` · ${c}`:``}`}createDatesListCard(e){let{bulletin:t,date:n,kind:r,label:i}=e,a=this.getCatMeta(t.category),o=this.getPostTitle(t),s=this.getLocale(),c=this.getCurrentLang()===`ES`,l=r===`deadline`?c?`LÍM`:`BY`:n.toLocaleDateString(s,{month:`short`}).toUpperCase(),u=n.getDate(),d=r===`deadline`?`#f08b1f`:a.accent;return`
            <article
