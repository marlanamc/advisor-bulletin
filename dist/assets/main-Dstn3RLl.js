import{D as e,I as t,M as n,N as r,V as i,a,c as o,d as s,f as c,h as l,i as u,j as d,l as f,n as p,r as m,t as h,u as g,z as _}from"./event-sessions-NTv6ueQO.js";function v(){return{lightbox:document.getElementById(`imgLightbox`),lightboxImg:document.getElementById(`imgLightboxImg`),closeBtn:document.getElementById(`imgLightboxClose`),backdrop:document.getElementById(`imgLightboxBackdrop`),openBtn:document.getElementById(`imgLightboxOpenBtn`)}}function y(){let{lightbox:e}=v();return!!(e&&e.classList.contains(`open`))}function b(e){let{lightbox:t,lightboxImg:n,openBtn:r}=v();!t||!n||!e||(n.classList.remove(`is-tall`),n.src=e,r&&(r.href=e),t.classList.add(`open`),t.setAttribute(`aria-hidden`,`false`),document.body.style.overflow=`hidden`,n.onload=function(){n.naturalHeight/n.naturalWidth>1.2&&n.classList.add(`is-tall`)})}function x(){let{lightbox:e,lightboxImg:t}=v();!e||!t||(e.classList.remove(`open`),e.setAttribute(`aria-hidden`,`true`),document.body.classList.contains(`modal-open`)||(document.body.style.overflow=``),t.src=``,t.classList.remove(`is-tall`))}function S(){let{lightbox:e,closeBtn:t,backdrop:n}=v();e&&(document.addEventListener(`click`,e=>{let t=e.target.closest(`.lightbox-trigger`);!t||!t.dataset.lightboxSrc||(e.preventDefault(),e.stopPropagation(),b(t.dataset.lightboxSrc))}),t&&t.addEventListener(`click`,x),n&&n.addEventListener(`click`,x),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&y()&&(e.stopImmediatePropagation(),x())},!0),window.openImageLightbox=b,window.closeImageLightbox=x,window.isImageLightboxOpen=y)}s(`student`);var C=new Set([`card_view`,`detail_open`,`link_click`,`pdf_open`,`share_click`,`category_click`,`resource_open`]);function w(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function T(){let e=navigator.userAgent;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)?`mobile`:`desktop`}function E(t,n={}){if(!C.has(t)||l===void 0)return Promise.resolve();let r={action:t,createdAt:i(),dayKey:w(),source:`student`,device:T(),contentType:n.contentType||(t===`category_click`?`category`:`post`)};return n.postId&&(r.postId=String(n.postId).slice(0,160)),n.category&&(r.category=String(n.category).slice(0,80)),e(_(l,`analyticsEvents`),r).catch(e=>{console.debug(`Student analytics skipped:`,e&&e.code?e.code:e)})}window.trackStudentEvent=E;var D=[];function O(e){return[...D,...e||[]]}var k={immigration:{labelEn:`Immigration`,labelEs:`Inmigración`,icon:`globe`,color:`#0d9488`},jobs:{labelEn:`Jobs`,labelEs:`Empleos`,icon:`briefcase`,color:`#24498f`},housing:{labelEn:`Housing`,labelEs:`Vivienda`,icon:`home`,color:`#df6b4a`},health:{labelEn:`Health`,labelEs:`Salud`,icon:`heart`,color:`#df477f`},food:{labelEn:`Food`,labelEs:`Comida`,icon:`food`,color:`#2f934f`},family:{labelEn:`Child Care`,labelEs:`Cuidado de niños`,icon:`family`,color:`#c99035`},esol:{labelEn:`English class`,labelEs:`Inglés`,icon:`abc`,color:`#8050d1`},hse:{labelEn:`GED / HSE`,labelEs:`Equivalencia escolar`,icon:`abc`,color:`#2563eb`},college:{labelEn:`College & Careers`,labelEs:`Universidad y carreras`,icon:`graduation`,color:`#0a1d3a`},"legal-aid":{labelEn:`Legal Help`,labelEs:`Ayuda legal`,icon:`scale`,color:`#7c3aed`},money:{labelEn:`Financial Help`,labelEs:`Ayuda financiera`,icon:`money`,color:`#1fa77e`},announcement:{labelEn:`Announcements`,labelEs:`Anuncios`,icon:`megaphone`,color:`#317dea`}},A=[`immigration`,`jobs`,`housing`,`health`,`food`],j=[`jobs`,`immigration`,`housing`,`health`,`food`,`family`,`hse`,`college`,`legal-aid`,`money`],M={all:{icon:`✨`,title:`Main Feed`,description:`New help, classes, jobs, and community support from your advisors.`,chips:[`New`,`Free help`,`This week`]},housing:{icon:`🏠`,title:`Housing Help`,description:`Find apartments, shelters, rent help, and housing support.`,chips:[`Emergency Housing`,`Apartments`,`Rent Help`,`Tenant Rights`]},job:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},jobs:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},immigration:{icon:`🌎`,title:`Immigration Help`,description:`Find legal help, citizenship support, and trusted local organizations.`,chips:[`Citizenship`,`Legal Help`,`Know Your Rights`,`Green Card`]},health:{icon:`❤️`,title:`Health Support`,description:`Find clinics, health information, mental health support, and care nearby.`,chips:[`Clinics`,`Mental Health`,`Insurance`,`Urgent Help`]},food:{icon:`🥕`,title:`Food Help`,description:`Find food pantries, meal programs, and grocery help for families.`,chips:[`Food Pantry`,`Meals`,`Delivery`,`Family Help`]},esol:{icon:`📘`,title:`Free Classes`,description:`Find English classes, adult education, GED, and student support.`,chips:[`English Class`,`GED`,`Conversation`,`Career English`]},college:{icon:`🎓`,title:`College Pathways`,description:`Find college, GED, certificates, and next-step education support.`,chips:[`GED`,`Certificates`,`Financial Aid`,`College Help`]},money:{icon:`💵`,title:`Money Help`,description:`Find financial coaching, benefits, tax help, and low-cost support.`,chips:[`Benefits`,`Tax Help`,`Budgeting`,`Free Support`]},childcare:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},family:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},training:{icon:`🧰`,title:`Training Posts`,description:`See advisor posts about workshops, skills training, certificates, and programs.`,chips:[`Workshops`,`Certificates`,`Career Skills`,`Programs`]},"career-fair":{icon:`📍`,title:`Career Fairs`,description:`Find hiring events, job fairs, and places to meet employers.`,chips:[`Hiring Events`,`Employers`,`Resume`,`Interviews`]},announcement:{icon:`📢`,title:`Announcements`,description:`School news, reminders, and general updates from your advisors.`,chips:[`School News`,`Reminders`,`Updates`,`Events`]}},N={shield:`
    ...
    <article class="pc ${f} ${i?`pc--expired`:``}" id="bulletin-${e.id}" data-bulletin-id="${e.id}" onclick="${d}" role="button" tabindex="0" style="cursor:pointer">
      ...
      <div class="pc__body">
        ...
        `}renderBulletinDetail(e){let t=this.getCatMeta(e.category),n=this.formatPostedDate(e.datePosted),r=this.getDetailImportantDate(e),i=(e.dateType===`sessions`?this.getBulletinEventSessions(e).length:0)>1,a=r&&r.kind===`deadline`&&this.isDeadlineClose(r.raw),o=this.isBulletinExpired(e),s=(e.advisorName||`?`).charAt(0).toUpperCase(),c=r&&(r.kind===`event`||r.kind===`start`),l=e.isSchoolCalendarAnchor?`<strong>School Calendar</strong>`:c?`<strong>${this.escapeHtml(e.advisorName||`Advisor`)}</strong>`:`<strong>${this.escapeHtml(e.advisorName||`Advisor`)}</strong> · ${n}`,u=e.description?this.renderFormattedDescription(e.description,`${e.id}-detail`):``,d=[e.classType?this.getClassTypeDisplay(e.classType):``,e.company||``,e.eventLocation||``].filter(Boolean).slice(0,3),f=this.getDetailContactAction(e),p=this.hasDetailInfoGridContent(e),m=(document.body.getAttribute(`data-lang`)||`EN`)===`ES`&&e.imageEs?e.imageEs:e.image,h=m?`<button type="button" class="post-detail-hero-zoom lightbox-trigger" data-lightbox-src="${this.escapeAttribute(m)}" aria-label="View full size flyer">
                <img class="post-detail-hero-image" src="${this.escapeAttribute(m)}" alt="">
            ...
            <article class="post-detail-page" style="--detail-accent:${t.accent};--detail-tint:${t.tint}">
                ...
                <section class="post-detail-panel">
                    ...
                    `:``}
                    ${u?`<div class="post-detail-description">${u}</div>`:``}
                    ...
                    ${d.length?`<div class="post-detail-tags">${d.map(e=>`<span>${this.escapeHtml(e)}</span>`).join(``)}</div>`:``}
                    ${e.contact?`<div class="post-detail-contact-note">${this.escapeHtml(e.contact).replace(/\n/g,`<br>`)}</div>`:``}
                    <div class="post-detail-actions">
                        ${f?`
                            <a href="${this.escapeAttribute(f.href)}" class="post-detail-action post-detail-action--primary">
                                ...
                                <span><strong>${this.escapeHtml(f.label)}</strong><small>${this.escapeHtml(f.value)}</small></span>
                            </a>
                        `:``}
                        ${e.pdfUrl?`
