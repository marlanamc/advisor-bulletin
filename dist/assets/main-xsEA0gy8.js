import{S as e,_ as t,c as n,d as r,f as i,g as a,h as o,l as s,n as c,r as l,s as u,t as d,u as f,v as p,w as m}from"./rich-text-LosQB9sJ.js";import{D as h,O as g,S as _,T as v,_ as y,k as b,p as x,v as S,y as C}from"./firebase-vendor-DSRqgB8d.js";function w(){return{lightbox:document.getElementById(`imgLightbox`),lightboxImg:document.getElementById(`imgLightboxImg`),closeBtn:document.getElementById(`imgLightboxClose`),backdrop:document.getElementById(`imgLightboxBackdrop`),openBtn:document.getElementById(`imgLightboxOpenBtn`)}}function T(){return document.body.classList.contains(`modal-open`)||document.body.classList.contains(`search-layer-open`)||document.body.classList.contains(`resource-sheet-open`)}function E(){let{lightbox:e}=w();return!!(e&&e.classList.contains(`open`))}function D(e){let{lightbox:t,lightboxImg:n,openBtn:r}=w();!t||!n||!e||(n.classList.remove(`is-tall`),n.src=e,r&&(r.href=e),t.classList.add(`open`),t.setAttribute(`aria-hidden`,`false`),T()||(document.body.style.overflow=`hidden`),n.onload=function(){n.naturalHeight/n.naturalWidth>1.2&&n.classList.add(`is-tall`)})}function O(){let{lightbox:e,lightboxImg:t}=w();!e||!t||(e.classList.remove(`open`),e.setAttribute(`aria-hidden`,`true`),document.body.style.overflow=``,t.src=``,t.classList.remove(`is-tall`))}function k(){let{lightbox:e,closeBtn:t,backdrop:n}=w();e&&(document.addEventListener(`click`,e=>{let t=e.target.closest(`.lightbox-trigger`);!t||!t.dataset.lightboxSrc||(e.preventDefault(),e.stopPropagation(),D(t.dataset.lightboxSrc))}),t&&t.addEventListener(`click`,O),n&&n.addEventListener(`click`,O),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&E()&&(e.stopImmediatePropagation(),O())},!0),window.openImageLightbox=D,window.closeImageLightbox=O,window.isImageLightboxOpen=E)}var A=h(b({apiKey:`AIzaSyBGaONCeB5MQCYdp3Gv8eUKPvLsBGFnXgY`,authDomain:`ebhcs-bulletin-board.firebaseapp.com`,projectId:`ebhcs-bulletin-board`,storageBucket:`ebhcs-bulletin-uploads-us`,messagingSenderId:`556649154585`,appId:`1:556649154585:web:3a3f49d2056aa507088288`}));p(`student`);function j(){return window.matchMedia(`(hover: none) and (pointer: coarse)`).matches}function M(e){return e||(j()?`auto`:`smooth`)}function N(e,t){window.scrollTo({top:Math.max(0,e),behavior:M(t)})}var P=new Set([`card_view`,`detail_open`,`link_click`,`pdf_open`,`share_click`,`category_click`,`resource_open`]);function F(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function I(){let e=navigator.userAgent;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)?`mobile`:`desktop`}function L(e,t={}){if(!P.has(e)||A===void 0)return Promise.resolve();let n={action:e,createdAt:g(),dayKey:F(),source:`student`,device:I(),contentType:t.contentType||(e===`category_click`?`category`:`post`)};return t.postId&&(n.postId=String(t.postId).slice(0,160)),t.category&&(n.category=String(t.category).slice(0,80)),x(v(A,`analyticsEvents`),n).catch(e=>{console.debug(`Student analytics skipped:`,e&&e.code?e.code:e)})}window.trackStudentEvent=L;var R=[];function z(e){return[...R,...e||[]]}var B={immigration:{labelEn:`Immigration`,labelEs:`Inmigración`,icon:`globe`,color:`#0d9488`},jobs:{labelEn:`Jobs`,labelEs:`Empleos`,icon:`briefcase`,color:`#24498f`},housing:{labelEn:`Housing`,labelEs:`Vivienda`,icon:`home`,color:`#df6b4a`},health:{labelEn:`Health`,labelEs:`Salud`,icon:`heart`,color:`#df477f`},food:{labelEn:`Food`,labelEs:`Comida`,icon:`food`,color:`#2f934f`},family:{labelEn:`Child Care`,labelEs:`Cuidado de niños`,icon:`family`,color:`#c99035`},esol:{labelEn:`English class`,labelEs:`Inglés`,icon:`abc`,color:`#8050d1`},hse:{labelEn:`GED / HSE`,labelEs:`Equivalencia escolar`,icon:`abc`,color:`#2563eb`},college:{labelEn:`College & Careers`,labelEs:`Universidad y carreras`,icon:`graduation`,color:`#0a1d3a`},"legal-aid":{labelEn:`Legal Help`,labelEs:`Ayuda legal`,icon:`scale`,color:`#7c3aed`},money:{labelEn:`Financial Help`,labelEs:`Ayuda financiera`,icon:`money`,color:`#1fa77e`},announcement:{labelEn:`Announcements`,labelEs:`Anuncios`,icon:`megaphone`,color:`#317dea`}},V=[`immigration`,`jobs`,`housing`,`health`,`food`],H=[`immigration`,`jobs`,`housing`,`health`,`food`,`family`,`hse`,`college`,`legal-aid`,`money`],U={"baby supplies":`Artículos para bebés`,"basic needs":`Necesidades básicas`,"cash assistance":`Ayuda en efectivo`,childcare:`Cuidado infantil`,"citizenship help":`Ayuda con ciudadanía`,clothing:`Ropa`,college:`Universidad`,"community help":`Ayuda comunitaria`,"credential evaluation":`Evaluación de credenciales`,"crisis hotline":`Línea de crisis`,"crisis support":`Apoyo en crisis`,"dental care":`Atención dental`,"document translation":`Traducción de documentos`,"emergency food pantry":`Despensa de emergencia`,"english classes":`Clases de inglés`,essentials:`Artículos esenciales`,"family help":`Ayuda familiar`,"family programs":`Programas familiares`,"family resource center":`Centro de recursos familiares`,"family shelter":`Refugio familiar`,"family support":`Apoyo familiar`,"find legal help":`Encuentre ayuda legal`,"find a clinic":`Encuentre una clínica`,"food benefits":`Beneficios de alimentos`,"food help":`Ayuda alimentaria`,"food hotline":`Línea de alimentos`,"food pantry":`Despensa de alimentos`,"free diapers":`Pañales gratis`,"free food":`Comida gratis`,"fuel help":`Ayuda con calefacción`,"grocery bags":`Bolsas de comestibles`,"health care":`Atención médica`,"health insurance help":`Ayuda con seguro médico`,"hot meals":`Comidas calientes`,"housing help":`Ayuda con vivienda`,"immigrant support":`Apoyo a inmigrantes`,"immigration help":`Ayuda con inmigración`,"job training":`Capacitación laboral`,"legal help":`Ayuda legal`,"legal information":`Información legal`,"low cost produce":`Productos a bajo costo`,"mobile food pantry":`Despensa móvil`,"parent support":`Apoyo a padres`,preschool:`Preescolar`,"public housing":`Vivienda pública`,"refugee support":`Apoyo a refugiados`,"rent help":`Ayuda con renta`,"snap help":`Ayuda con SNAP`,"tax help":`Ayuda con impuestos`,"tenant rights":`Derechos del inquilino`,"trauma support":`Apoyo en trauma`,"unemployment help":`Ayuda con desempleo`,"utility help":`Ayuda con servicios`,"wic help":`Ayuda con WIC`,"worker rights":`Derechos del trabajador`};function W(e){let t=String(e||``).trim();return t?U[t.toLowerCase()]||t:``}var G={all:{icon:`✨`,title:`Main Feed`,description:`New help, classes, jobs, and community support from your advisors.`,chips:[`New`,`Free help`,`This week`]},housing:{icon:`🏠`,title:`Housing Help`,description:`Find apartments, shelters, rent help, and housing support.`,chips:[`Emergency Housing`,`Apartments`,`Rent Help`,`Tenant Rights`]},job:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},jobs:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},immigration:{icon:`🌎`,title:`Immigration Help`,description:`Find legal help, citizenship support, and trusted local organizations.`,chips:[`Citizenship`,`Legal Help`,`Know Your Rights`,`Green Card`]},health:{icon:`❤️`,title:`Health Support`,description:`Find clinics, health information, mental health support, and care nearby.`,chips:[`Clinics`,`Mental Health`,`Insurance`,`Urgent Help`]},food:{icon:`🥕`,title:`Food Help`,description:`Find food pantries, meal programs, and grocery help for families.`,chips:[`Food Pantry`,`Meals`,`Delivery`,`Family Help`]},esol:{icon:`📘`,title:`Free Classes`,description:`Find English classes, adult education, GED, and student support.`,chips:[`English Class`,`GED`,`Conversation`,`Career English`]},college:{icon:`🎓`,title:`College Pathways`,description:`Find college, GED, certificates, and next-step education support.`,chips:[`GED`,`Certificates`,`Financial Aid`,`College Help`]},money:{icon:`💵`,title:`Money Help`,description:`Find financial coaching, benefits, tax help, and low-cost support.`,chips:[`Benefits`,`Tax Help`,`Budgeting`,`Free Support`]},childcare:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},family:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},training:{icon:`🧰`,title:`Training Posts`,description:`See advisor posts about workshops, skills training, certificates, and programs.`,chips:[`Workshops`,`Certificates`,`Career Skills`,`Programs`]},"career-fair":{icon:`📍`,title:`Career Fairs`,description:`Find hiring events, job fairs, and places to meet employers.`,chips:[`Hiring Events`,`Employers`,`Resume`,`Interviews`]},announcement:{icon:`📢`,title:`Announcements`,description:`School news, reminders, and general updates from your advisors.`,chips:[`School News`,`Reminders`,`Updates`,`Events`]}},K={shield:`
    ...
    `},q=class p{constructor(){this.currentUser=null,this.bulletins=[],this.filteredPosts=[],this.lastHashHighlight=null,this.currentView=`feed`,this.currentFeedCategory=`all`,this.currentResourceCategory=`all`,this.currentDesktopResourceTopic=`all`,this.expandedDesktopResourceSections=new Set,this.mobileResourceCategoryReturnView=`categories`,this.resourceSearchQuery=``,this.resourceSortMode=`default`,this.datesViewMode=`list`,this.isSearchLayerOpen=!1,this.trackedCardViews=new Set,this.activeDetailBulletinId=null,this.bulletinsHydrated=!1,this.handleHashChange=this.handleHashRouting.bind(this),this.handleDescriptionToggle=this.handleDescriptionToggle.bind(this),this.init()}init(){this.currentCalendarMonth=new Date().getMonth(),this.currentCalendarYear=new Date().getFullYear(),this.bindEvents(),this.loadBulletins(),this.checkAutoLogin(),this.setupRealtimeListener(),this.switchView(`feed`,{skipRender:!0,preserveDetail:!0}),this.closeSearchLayer({preserveScroll:!0,silent:!0}),window.addEventListener(`hashchange`,this.handleHashChange)}static CACHE_KEY=`ebhcs_bulletins_v1`;static CACHE_TTL=300*1e3;_readCache(){try{let e=sessionStorage.getItem(p.CACHE_KEY);if(!e)return null;let{ts:t,bulletins:n}=JSON.parse(e);return Date.now()-t>p.CACHE_TTL?null:n}catch{return null}}_writeCache(e){try{sessionStorage.setItem(p.CACHE_KEY,JSON.stringify({ts:Date.now(),bulletins:e}))}catch{}}showBulletinsLoading(){let e=document.getElementById(`bulletinGrid`),t=document.getElementById(`feedEmptyState`);t&&(t.style.display=`none`),e&&(e.innerHTML=`
                <div class="feed-loading-state" role="status" aria-live="polite">
                    <p>Loading posts…</p>
                    <p class="empty-state-bilingual">Cargando publicaciones…</p>
                </div>
            `)}applyBulletinSnapshot(e){let t=[];e.forEach(e=>{t.push({id:e.id,...this.normalizeBulletin(e.data())})}),this.bulletins=t,this.bulletinsHydrated=!0,this._writeCache(this.bulletins),this.populateAdvisorFilters(),this.renderResourceCategoryFilters(),this.displayBulletins()}setupRealtimeListener(){let e=this._readCache();e&&e.length>0?(this.bulletins=e,this.bulletinsHydrated=!0,this.populateAdvisorFilters(),this.renderResourceCategoryFilters(),this.displayBulletins()):this.showBulletinsLoading(),y(C(v(A,`bulletins`),_(`isActive`,`==`,!0),S(`datePosted`,`desc`)),e=>{e.empty&&e.metadata.fromCache&&!this.bulletinsHydrated||this.applyBulletinSnapshot(e)},e=>{console.error(`Error loading bulletins:`,e),this.bulletinsHydrated=!0;let t=document.getElementById(`bulletinGrid`);if(t){if(this.bulletins.length>0){this.displayBulletins();return}t.innerHTML=`<div class="feed-load-error" role="alert"><p>Could not load posts. Check your connection and try again.</p><p class="empty-state-bilingual">No se pudieron cargar las publicaciones. Comprueba tu conexión.</p></div>`}})}normalizeBulletin(e){let t=e.type||`post`,n={...e,type:t};if(t===`resource`&&(n.isPublished=e.isPublished!==!1),n.dateType===`sessions`){let t=e.startTime||``,r=e.endTime||``;Array.isArray(e.eventDates)&&e.eventDates.length?n.eventDates=i(e.eventDates,t,r):e.eventDate?n.eventDates=i([e.eventDate],t,r):n.eventDates=[],n.eventDate=n.eventDates[0]?.date||e.eventDate||``}return n}getBulletinEventSessions(e){if(!e||e.dateType!==`sessions`)return[];let t=e.startTime||``,n=e.endTime||``;return Array.isArray(e.eventDates)&&e.eventDates.length?i(e.eventDates,t,n):e.eventDate?i([e.eventDate],t,n):[]}getBulletinEventDates(e){return e?e.dateType===`sessions`?this.getBulletinEventSessions(e).map(e=>e.date):e.eventDate?[String(e.eventDate).split(`T`)[0]]:e.startDate?[String(e.startDate).split(`T`)[0]]:e.deadline?[String(e.deadline).split(`T`)[0]]:[]:[]}formatEventDatesDisplay(e){if(e.dateType===`sessions`){let t=this.getBulletinEventSessions(e);if(!t.length)return null;if(t.length===1){let n=this.parseDateOnly(t[0].date);return n?this.getDatesListLabel(e,n,`event`,{session:t[0]}):null}let n=this.getLocale(),r=t.map(e=>{let t=this.parseStoredYmdLocal(e.date),r=t?t.toLocaleDateString(n,{weekday:`short`,month:`short`,day:`numeric`}):e.date,i=this.formatTimeRange(e.startTime,e.endTime);return i?`${r} · ${i}`:r});return r.length===2?`${r[0]} & ${r[1]}`:this.getCurrentLang()===`ES`?`${r.length} sesiones`:`${r.length} sessions`}let t=this.getDatesListItem(e);return t?t.label:null}isApplicationDeadline(e){if(e.dateType===`deadline`){let t=e.eventDate||e.deadline;return t?this.isDeadlineClose(t):!1}return!e.dateType&&e.deadline&&!e.eventDate&&!e.startDate?this.isDeadlineClose(e.deadline):!1}formatStartDateLabelHtml(e,t){let n=this.getLocale(),r=this.getCurrentLang()===`ES`,i=e.toLocaleDateString(n,{weekday:`short`,month:`short`,day:`numeric`}),a=e.toLocaleDateString(n,{weekday:`long`,month:`short`,day:`numeric`}),o=this.formatTimeRange(t.startTime,t.endTime),s=o?` · ${this.escapeHtml(o)}`:``,c=r?`Comienza el`:`Starts`,l=r?a:i;return`<strong class="date-label-prefix">${this.escapeHtml(c)}</strong> ${this.escapeHtml(l)}${s}`}formatFeedDateDisplayHtml(e){if(e.dateType===`sessions`){let t=this.formatEventDatesDisplay(e);return t?this.escapeHtml(t):``}let t=this.getDatesListItem(e);return t?t.kind===`start`?this.formatStartDateLabelHtml(t.date,e):this.escapeHtml(t.label):``}formatSessionDatesDetailLabel(e){let t=this.getBulletinEventSessions(e);if(!t.length)return``;if(t.length===1){let e=t[0],n=this.parseStoredYmdLocal(e.date),r=n?n.toLocaleDateString(`en-US`,{weekday:`long`,month:`short`,day:`numeric`}):e.date,i=this.formatTimeRange(e.startTime,e.endTime);return i?`${r} · ${i}`:r}let n=o(t)?this.formatTimeRange(t[0].startTime,t[0].endTime):``;return n?`${t.length} sessions · ${n}`:`${t.length} sessions`}buildSessionDatesDetailHtml(e){let t=this.getBulletinEventSessions(e);if(!t.length)return``;let n=e=>{let t=this.parseStoredYmdLocal(e);return t?t.toLocaleDateString(`en-US`,{weekday:`long`,month:`short`,day:`numeric`}):e};if(t.length===1){let e=t[0],r=this.formatTimeRange(e.startTime,e.endTime),i=r?`${n(e.date)} · ${r}`:n(e.date);return`<small>${this.escapeHtml(i)}</small>`}let r=o(t),i=r?this.formatTimeRange(t[0].startTime,t[0].endTime):``,a=t.map(e=>{let t=n(e.date);if(r)return`<li>${this.escapeHtml(t)}</li>`;let i=this.formatTimeRange(e.startTime,e.endTime);return i?`<li><span class="post-detail-session-date">${this.escapeHtml(t)}</span><span class="post-detail-session-time">${this.escapeHtml(i)}</span></li>`:`<li>${this.escapeHtml(t)}</li>`}).join(``);return`
            ${i?`<p class="post-detail-session-shared-time">${this.escapeHtml(i)} each session</p>`:``}
            <ul class="post-detail-session-list">${a}</ul>
        `}bulletinHasCalendarDates(e){return!!(e.deadline||e.eventDate||e.startDate||e.dateType===`sessions`&&Array.isArray(e.eventDates)&&e.eventDates.length)}populateAdvisorFilters(){let e=[...new Set(this.getPostBulletins(this.bulletins).map(e=>e.advisorName).filter(e=>e))];e.sort();let t=document.getElementById(`postedByChips`);t&&(t.innerHTML=``,e.forEach(e=>{let n=document.createElement(`button`);n.className=`filter-chip postedby-chip`,n.setAttribute(`data-postedby`,e),n.textContent=`👤 ${e}`,n.addEventListener(`click`,e=>this.toggleFilterChip(e.target,`postedby`)),t.appendChild(n)}))}bindEvents(){document.querySelectorAll(`[data-app-view]`).forEach(e=>{e.addEventListener(`click`,t=>{e.tagName===`A`&&t.preventDefault();let n=e.getAttribute(`data-app-view`);n&&(this.switchView(n),e.hasAttribute(`data-scroll-home`)&&N(0))})});let e=document.getElementById(`searchInput`),t=document.getElementById(`searchBtn`),n=document.getElementById(`clearFilters`);e&&e.addEventListener(`input`,()=>this.applyFilters()),t&&t.addEventListener(`click`,()=>this.applyFilters()),n&&n.addEventListener(`click`,()=>this.clearFilters());let r=document.getElementById(`heroSearchInput`),i=document.getElementById(`heroSearchBtn`),a=()=>{e&&r&&(e.value=r.value),this.applyFilters()};r&&(r.addEventListener(`input`,a),r.addEventListener(`keydown`,e=>{e.key===`Enter`&&a()})),i&&i.addEventListener(`click`,a);let o=document.getElementById(`desktopTopbarSearchInput`),s=document.getElementById(`desktopTopbarSearchBtn`),c=()=>{e&&o&&(e.value=o.value),r&&o&&(r.value=o.value),this.applyFilters()};o&&(o.addEventListener(`input`,c),o.addEventListener(`keydown`,e=>{e.key===`Enter`&&c()})),s&&s.addEventListener(`click`,c),document.querySelectorAll(`[data-lang-switch]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-lang-switch`)||`EN`;this.setLanguage(t)})}),document.querySelectorAll(`.feed-popular-chip`).forEach(t=>{t.addEventListener(`click`,()=>{let n=t.getAttribute(`data-search-term`)||``;r&&(r.value=n),e&&(e.value=n),o&&(o.value=n),this.applyFilters()})}),document.querySelectorAll(`.cat-chip[data-cat-filter]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-cat-filter`)||`all`;this.setFeedCategory(t)})});let l=document.getElementById(`toggleFilters`);l&&l.addEventListener(`click`,()=>{this.toggleFiltersPanel()});let u=document.getElementById(`mobileSearchTrigger`);u&&u.addEventListener(`click`,()=>this.toggleSearchLayer()),document.querySelectorAll(`[data-close-search-layer]`).forEach(e=>{e.addEventListener(`click`,()=>this.closeSearchLayer())});let d=document.getElementById(`closeSearchLayer`);d&&d.addEventListener(`click`,()=>this.closeSearchLayer()),document.querySelectorAll(`.sl-cat-btn[data-cat-filter]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-cat-filter`)||`all`;this.setFeedCategory(t),this.updateSearchLayerCatState(t),this.closeSearchLayer()})}),this.selectedCategories=[],this.selectedPostedDates=[],this.selectedDeadlines=[],this.selectedClassTypes=[],this.selectedPostedBy=[],document.querySelectorAll(`.filter-chip[data-category]`).forEach(e=>{e.addEventListener(`click`,e=>this.toggleFilterChip(e.target,`category`))}),document.querySelectorAll(`.filter-chip[data-posted]`).forEach(e=>{e.addEventListener(`click`,e=>this.toggleFilterChip(e.target,`posted`))}),document.querySelectorAll(`.filter-chip[data-deadline]`).forEach(e=>{e.addEventListener(`click`,e=>this.toggleFilterChip(e.target,`deadline`))}),document.querySelectorAll(`.filter-chip[data-classtype]`).forEach(e=>{e.addEventListener(`click`,e=>this.toggleFilterChip(e.target,`classtype`))}),document.querySelectorAll(`.filter-chip[data-postedby]`).forEach(e=>{e.addEventListener(`click`,e=>this.toggleFilterChip(e.target,`postedby`))});let f=document.getElementById(`showExpiredToggle`);f&&f.addEventListener(`change`,()=>this.applyFilters());let p=document.getElementById(`resourceCategoryFilters`);p&&p.addEventListener(`click`,e=>{let t=e.target.closest(`.resource-category-chip, .resource-category-tile`);if(!t)return;let n=t.getAttribute(`data-resource-category`)||`all`;n!==`all`&&L(`category_click`,{category:n,contentType:`category`}),this.openResourceShortcut(n)}),document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-resource-shortcut]`);if(!t)return;let n=t.getAttribute(`data-resource-shortcut`);n&&(L(`category_click`,{category:n,contentType:`category`}),this.openResourceShortcut(n))});let m=document.getElementById(`feedCategoryClear`);m&&m.addEventListener(`click`,()=>this.setFeedCategory(`all`)),this.setupResourceDetailSheet(),document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-analytics-action]`);t&&L(t.getAttribute(`data-analytics-action`),{postId:t.getAttribute(`data-analytics-post-id`)||``,category:t.getAttribute(`data-analytics-category`)||``,contentType:t.getAttribute(`data-analytics-content-type`)||`post`})});let h=document.getElementById(`closeBulletinDetail`);h&&h.addEventListener(`click`,()=>this.closeBulletinDetail());let g=document.getElementById(`bulletinDetailModal`);g&&g.addEventListener(`click`,e=>{e.target===g&&this.closeBulletinDetail()}),document.addEventListener(`keydown`,e=>{if(e.key===`Escape`){if(typeof window.isImageLightboxOpen==`function`&&window.isImageLightboxOpen())return;if(this.isSearchLayerOpen){this.closeSearchLayer();return}let e=document.getElementById(`catDetailSheet`);if(e&&e.classList.contains(`open`)){this.closeResourceDetailSheet();return}let t=document.getElementById(`bulletinDetailModal`);t&&t.style.display===`flex`&&this.closeBulletinDetail()}}),document.addEventListener(`click`,this.handleDescriptionToggle),this.setupResourceSort(),this.setupCopyLinks(),this.setupBackToTop(),document.querySelectorAll(`[data-dates-view]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-dates-view`);t&&(this.datesViewMode=t,this.renderCalendar(this.filteredPosts.length>0?this.filteredPosts:this.getPostBulletins(this.bulletins)))})});let _=window.matchMedia(`(min-width: 768px)`).matches;window.addEventListener(`resize`,()=>{let e=window.matchMedia(`(min-width: 768px)`).matches;e!==_&&(_=e,this.renderResourcesSections(this.getPublishedResources()))});let v=window.matchMedia(`(min-width: 1024px)`).matches;window.addEventListener(`resize`,()=>{let e=window.matchMedia(`(min-width: 1024px)`).matches;e!==v&&(v=e,this.renderCalendar(this.filteredPosts.length>0?this.filteredPosts:this.getPostBulletins(this.bulletins)))})}setupResourceDetailSheet(){let e=document.getElementById(`catDetailSheet`),t=document.getElementById(`catDetailBackdrop`),n=document.getElementById(`catDetailBack`),r=document.getElementById(`catDetailClose`);if(!e)return;[n,r,t].forEach(e=>{e&&e.addEventListener(`click`,()=>this.closeResourceDetailSheet())}),document.addEventListener(`click`,e=>{e.target.closest(`#catDetailClose, #catDetailBack, #catDetailBackdrop`)&&(e.preventDefault(),e.stopPropagation(),this.closeResourceDetailSheet())},!0),e.addEventListener(`click`,e=>{let t=e.target.closest(`[data-cat-show-all]`);if(t){let e=t.getAttribute(`data-cat-show-all`);e&&(this.closeResourceDetailSheet(),this.navigateToResourceCategory(e,{expandDesktop:!0}));return}let n=e.target.closest(`[data-resource-more]`);n&&(e.preventDefault(),this.openResourceFromSheet(n.getAttribute(`data-resource-more`)))});let i=0,a=0,o=!1,s=null,c=()=>{o=!1,s=null,e.style.removeProperty(`--cat-sheet-drag-y`),e.classList.remove(`is-dragging`)};e.addEventListener(`pointerdown`,t=>{window.matchMedia(`(max-width: 767px)`).matches&&(t.target.closest(`button, a`)||t.target.closest(`.cat-detail-topbar`)&&(s=t.pointerId,i=t.clientY,a=t.clientY,o=!0,e.classList.add(`is-dragging`),e.setPointerCapture(s)))});let l=t=>{i=t,a=t,o=!0,s=`fallback`,e.classList.add(`is-dragging`)},u=t=>{if(!o)return;a=t;let n=Math.max(0,a-i);e.style.setProperty(`--cat-sheet-drag-y`,`${n}px`)},d=()=>{if(!o)return;let e=Math.max(0,a-i);c(),e>78&&this.closeResourceDetailSheet()};e.addEventListener(`mousedown`,e=>{window.matchMedia(`(max-width: 767px)`).matches&&(e.target.closest(`button, a`)||e.target.closest(`.cat-detail-topbar`)&&l(e.clientY))}),document.addEventListener(`mousemove`,e=>{s===`fallback`&&u(e.clientY)}),document.addEventListener(`mouseup`,()=>{s===`fallback`&&d()}),e.addEventListener(`touchstart`,e=>{window.matchMedia(`(max-width: 767px)`).matches&&(e.target.closest(`button, a`)||e.target.closest(`.cat-detail-topbar`)&&l(e.touches[0].clientY))},{passive:!0}),document.addEventListener(`touchmove`,e=>{s!==`fallback`||e.touches.length===0||u(e.touches[0].clientY)},{passive:!0}),document.addEventListener(`touchend`,()=>{s===`fallback`&&d()});let f=t=>{if(!o||t.pointerId!==s)return;a=t.clientY;let n=Math.max(0,a-i);e.style.setProperty(`--cat-sheet-drag-y`,`${n}px`)},p=e=>{if(!o||e.pointerId!==s)return;let t=Math.max(0,a-i);c(),t>78&&this.closeResourceDetailSheet()};e.addEventListener(`pointermove`,f),e.addEventListener(`pointerup`,p),document.addEventListener(`pointermove`,f),document.addEventListener(`pointerup`,p),e.addEventListener(`pointercancel`,c)}setupResourceSort(){let e=document.querySelectorAll(`.resource-sort-btn`);e.forEach(t=>{t.addEventListener(`click`,()=>{e.forEach(e=>e.classList.remove(`active`)),t.classList.add(`active`),this.resourceSortMode=t.dataset.sort,this.renderResourceList(this.getPublishedResources())})})}setupCopyLinks(){document.addEventListener(`click`,async e=>{let t=e.target.closest(`.resource-copy-btn`);if(!t)return;e.preventDefault(),e.stopPropagation();let n=t.dataset.url;try{await navigator.clipboard.writeText(n),t.classList.add(`copied`),setTimeout(()=>{t.classList.remove(`copied`)},2e3)}catch(e){console.error(`Failed to copy:`,e)}})}setupBackToTop(){let e=document.getElementById(`backToTop`);if(!e)return;let t=!1,n=()=>{let n=window.scrollY>400;e.classList.toggle(`visible`,n),t=!1};window.addEventListener(`scroll`,()=>{t||=(requestAnimationFrame(n),!0)},{passive:!0}),e.addEventListener(`click`,()=>{N(0)})}switchView(e,t={}){if(![`feed`,`calendar`,`resources`,`about`,`advisors`].includes(e))return;let n=this.currentView;this.currentView=e,document.body.setAttribute(`data-current-view`,e),e===`resources`&&n!==`resources`&&!t.preserveResourceNavigation&&(this.currentDesktopResourceTopic=`all`,this.currentResourceCategory=`all`,this.expandedDesktopResourceSections.clear()),n===`resources`&&e!==`resources`&&(this.currentResourceCategory=`all`,this.currentDesktopResourceTopic=`all`,this.expandedDesktopResourceSections.clear(),this.mobileResourceCategoryReturnView=`categories`,document.body.classList.remove(`resource-category-detail-open`)),e===`advisors`&&this.renderStudentAdvisorDirectory(),e===`about`&&this.renderAboutAdvisorList(),window.matchMedia(`(max-width: 768px)`).matches&&N(0),document.querySelectorAll(`[data-view-panel]`).forEach(t=>{t.classList.toggle(`active`,t.getAttribute(`data-view-panel`)===e)}),document.querySelectorAll(`[data-app-view]`).forEach(t=>{let n=t.getAttribute(`data-app-view`)===e;t.classList.toggle(`active`,n),t.setAttribute(`aria-pressed`,String(n)),t.classList.contains(`mobile-tab`)&&t.setAttribute(`aria-current`,n?`page`:`false`)}),e!==`feed`&&!t.preserveDetail&&this.closeBulletinDetail(!1),e!==`feed`&&e!==`resources`&&this.closeSearchLayer({preserveScroll:!0,silent:!0}),this.syncHeaderSearchButton(),this.updateSearchPlaceholder(),!t.skipRender&&e!==`advisors`&&(this.filteredPosts.length>0||this.bulletins.length===0?this.displayBulletins(this.filteredPosts):this.applyFilters())}getAdvisorInitials(e=``){return e.trim().split(/\s+/).map(e=>e[0]||``).join(``).slice(0,2).toUpperCase()}getAdvisorAvatarColor(e){let t=[`#24498f`,`#0d9488`,`#df6b4a`,`#df477f`,`#2f934f`,`#c99035`,`#2563eb`,`#0a1d3a`,`#7c3aed`,`#1fa77e`,`#8050d1`,`#317dea`];return{background:t[((Number(e)||0)%t.length+t.length)%t.length],color:`#ffffff`}}renderStudentAdvisorDirectory(){let t=document.getElementById(`advisorsDirectoryList`);t&&(t.innerHTML=e.map((t,n)=>{let r=this.escapeHtml(t.name),i=this.escapeHtml(t.role),a=this.escapeHtml(t.email||``),o=this.escapeHtml(this.getAdvisorInitials(t.name)),s=this.getAdvisorAvatarColor(n,e.length);return`
                <article class="advisor-dir-card">
                    ...
                    <div class="advisor-dir-card-body">
                        <h2 class="advisor-dir-name">${r}</h2>
                        <p class="advisor-dir-role">${i}</p>
                    </div>
                    <a class="advisor-dir-email-btn" href="mailto:${a}" aria-label="Email ${r} at ${a}">
            ...
            `}).join(``))}renderAboutAdvisorList(){let t=document.getElementById(`aboutAdvisorList`);t&&t.dataset.rendered!==`true`&&(t.innerHTML=e.map((t,n)=>{let r=this.escapeHtml(t.name),i=this.escapeHtml(t.role),a=this.escapeHtml(t.email||``),o=this.escapeHtml(this.getAdvisorInitials(t.name)),s=this.getAdvisorAvatarColor(n,e.length);return`
                <a class="about-advisor-row" href="mailto:${a}" aria-label="Email ${r} at ${a}">
                    <span class="about-advisor-row-avatar" style="background:${s.background};color:${s.color}" aria-hidden="true">${o}</span>
                    <span class="about-advisor-row-text">
                        <span class="about-advisor-row-name">${r}</span>
                        <span class="about-advisor-row-role">${i}</span>
                    </span>
        ...
        `}createFeedCategoryResourceCard(e){let{titleEn:t}=this.getResourceTitles(e),n=e.description?this.formatRichTextInline(e.description):``,r=this.getResourceUrl(e),i=e.phone||``,a=e.tel||(i?`tel:${i.replace(/[^0-9+]/g,``)}`:``),o=e.address||``,s=e.mapUrl||(o?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(o)}`:``),c=a||(r===`#`?s:r),l=a?`Call`:r===`#`?`Directions`:`Website`;return`
        ...
        `}updateSearchLayerCatState(e){let t=this.normalizeFeedCategory(e);document.querySelectorAll(`.sl-cat-btn[data-cat-filter]`).forEach(e=>{let n=e.getAttribute(`data-cat-filter`),r=n===`all`?t===`all`:this.normalizeFeedCategory(n)===t;e.classList.toggle(`active`,r)})}updateActiveCategoryState(){let e=this.currentFeedCategory||`all`;document.querySelectorAll(`.cat-chip[data-cat-filter]`).forEach(t=>{let n=this.normalizeFeedCategory(t.getAttribute(`data-cat-filter`)||`all`);t.classList.toggle(`active`,n===e||e===`all`&&n===`all`)}),document.querySelectorAll(`.story-bubble[data-app-view-cat]`).forEach(t=>{let n=this.normalizeFeedCategory(t.getAttribute(`data-app-view-cat`)||`all`);t.classList.toggle(`active`,n===e),t.setAttribute(`aria-pressed`,String(n===e))})}toggleSearchLayer(){this.isSearchLayerOpen?this.closeSearchLayer():this.openSearchLayer()}openSearchLayer(){this.currentView!==`feed`&&this.switchView(`feed`,{skipRender:!0,preserveDetail:!0}),this.isSearchLayerOpen=!0;let e=document.getElementById(`searchLayer`);e&&(e.classList.add(`open`),e.setAttribute(`aria-hidden`,`false`)),document.body.classList.add(`search-layer-open`),this.syncHeaderSearchButton(),window.matchMedia(`(max-width: 768px)`).matches&&window.setTimeout(()=>{document.getElementById(`searchInput`)?.focus()},180)}closeSearchLayer(e={}){this.isSearchLayerOpen=!1;let t=document.getElementById(`searchLayer`);t&&(t.classList.remove(`open`),t.setAttribute(`aria-hidden`,`true`)),document.body.classList.remove(`search-layer-open`),e.silent||this.syncHeaderSearchButton()}syncHeaderSearchButton(){let e=document.getElementById(`mobileSearchTrigger`);if(!e)return;let t=this.currentView===`feed`||this.currentView===`resources`;e.hidden=!t;let n=this.currentView===`resources`?this.resourceSearchQuery&&this.resourceSearchQuery.trim()!==``:this.areFiltersApplied();e.classList.toggle(`active`,t&&(this.isSearchLayerOpen||n)),e.setAttribute(`aria-expanded`,t&&this.isSearchLayerOpen?`true`:`false`)}setLanguage(e){let t=e===`ES`?`ES`:`EN`;document.body.setAttribute(`data-lang`,t),document.documentElement.setAttribute(`data-lang`,t),document.querySelectorAll(`[data-lang-switch]`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-lang-switch`)===t)}),this.updateSearchPlaceholder(),this.currentView===`resources`?this.renderResourcesSections(this.getPublishedResources()):this.applyFilters();let n=document.getElementById(`bulletinDetailModal`);this.activeDetailBulletinId&&n?.style.display===`flex`&&this.showBulletinDetail(this.activeDetailBulletinId)}updateSearchPlaceholder(){let e=document.getElementById(`searchInput`),t=document.getElementById(`desktopTopbarSearchInput`),n=document.getElementById(`mobileInlineSearchInput`),r=document.body.getAttribute(`data-lang`)===`ES`,i=this.currentView===`resources`,a=i?r?`Busca ayuda...`:`Search help...`:r?`Busca ayuda, anuncios y eventos...`:`Search for help, announcements, and events...`,o=i?r?`Busca ayuda...`:`Search help...`:r?`¿Con qué necesitas ayuda?`:`What do you need help with?`;t&&(t.placeholder=a),[e,n].filter(Boolean).forEach(e=>{e.placeholder=o})}renderFeed(e){let t=document.getElementById(`bulletinGrid`),n=document.getElementById(`feedEmptyState`);if(!(!t||!n)){if(!this.bulletinsHydrated){this.showBulletinsLoading();return}if(e.length===0){t.innerHTML=``,n.innerHTML=this.areFiltersApplied()?`<h3>No bulletins found</h3><p>Try adjusting your search or filter criteria.</p>`:`<h3>No bulletins posted yet</h3><p>Advisors can log in to post job opportunities, training sessions, and important announcements.</p>`,n.style.display=`block`;return}n.style.display=`none`,t.innerHTML=e.map(e=>this.createBulletinCard(e)).join(``),this.trackRenderedCardViews(e)}}trackRenderedCardViews(e){e.forEach(e=>{!e.id||this.trackedCardViews.has(e.id)||(this.trackedCardViews.add(e.id),L(`card_view`,{postId:e.id,category:e.category,contentType:e.type||`post`}))})}renderCalendar(e){let t=document.getElementById(`bulletinCalendar`),n=document.getElementById(`calendarEmptyState`),r=document.getElementById(`bulletinCalendarDesktopGrid`);if(!t||!n)return;let i=z(e),a=i.filter(e=>this.bulletinHasCalendarDates(e));if(a.length===0){t.innerHTML=``,r&&(r.innerHTML=``),n.style.display=`block`;return}n.style.display=`none`,this.updateDatesViewToggle(),window.matchMedia(`(min-width: 1024px)`).matches?(t.innerHTML=this.createDatesListView(a),r&&(r.innerHTML=this.createCalendarView(i,{navigatorMode:!0}),this.bindCalendarDayScroll(r))):(t.innerHTML=this.datesViewMode===`calendar`?this.createCalendarView(i):this.createDatesListView(a),r&&(r.innerHTML=``))}bindCalendarDayScroll(e){e.querySelectorAll(`[data-calendar-day]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-calendar-day`);if(!t)return;let n=document.querySelector(`[data-list-date="${t}"]`);if(!n)return;let r=parseInt(getComputedStyle(document.documentElement).getPropertyValue(`--app-header-offset`)||`70`,10);N(window.scrollY+n.getBoundingClientRect().top-r-16),n.classList.add(`list-card-pulse`),setTimeout(()=>n.classList.remove(`list-card-pulse`),1400)})})}renderHomeUpcomingEvents(e){let t=document.getElementById(`homeUpcomingEvents`);if(!t)return;let n=new Date;n.setHours(0,0,0,0);let r=z(e).flatMap(e=>{if(e.dateType===`sessions`)return this.getBulletinEventDates(e).map(t=>({bulletin:e,rawDate:t,timestamp:this.getTimestampValue(t)}));let t=e.eventDate||e.startDate||e.deadline;return[{bulletin:e,rawDate:t,timestamp:this.getTimestampValue(t)}]}).filter(e=>e.timestamp&&e.timestamp>=n.getTime()).sort((e,t)=>e.timestamp-t.timestamp).slice(0,3);if(r.length===0){t.innerHTML=`<div class="side-empty">Events with dates will appear here.</div>`;return}t.innerHTML=r.map(({bulletin:e,rawDate:t,timestamp:n})=>{let r=new Date(n),i=this.getLocale(),a=r.toLocaleDateString(i,{month:`short`}).toUpperCase(),o=r.toLocaleDateString(i,{day:`numeric`}),s=[r.toLocaleDateString(i,{weekday:`long`}),e.startTime||``].filter(Boolean).join(` · `);return`
            ...
            `}).join(``)||`<p class="hero-resources-empty">No help links available yet.</p>`,t.querySelectorAll(`.hero-resource-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.resourceCategory;this.openResourceShortcut(t)})})}renderResourceStoryRow(e,t,n){let r=document.getElementById(e);if(!r)return;if(r.innerHTML=n.map(e=>this.createResourceStoryBubble(e)).join(``),!t){r.style.display=n.length>0?`flex`:`none`;return}let i=document.getElementById(t);if(!i)return;let a=n.length>0;r.style.display=a?`flex`:`none`,i.style.display=a?`none`:`block`}renderResourceCategoryFilters(){let e=document.getElementById(`resourceCategoryFilters`);if(!e)return;let t=this.getPublishedResources();e.innerHTML=H.map(e=>{let n=B[e];if(!n)return``;let r=t.filter(t=>this.getResourceCategoryKey(t)===e).length,i=K[n.icon]||K.globe,a=this.getResourceCountNoun(r,`en`),o=this.getResourceCountNoun(r,`es`);return`
            <button
                type="button"
        ...
        `}).join(``)}renderResourceCategoryDetailHeader(e){let t=document.getElementById(`resourceCategoryDetail`),n=document.getElementById(`resourceCategoryFilters`);if(!t)return;let r=this.currentResourceCategory,i=r&&r!==`all`?B[r]:null,a=window.matchMedia(`(max-width: 767px)`).matches;if(!e||!i||!a){t.hidden=!0,t.style.display=`none`,t.innerHTML=``,n&&(n.hidden=!1,n.style.removeProperty(`display`)),document.body.classList.remove(`resource-category-detail-open`);return}document.body.classList.add(`resource-category-detail-open`);let o=this.getPublishedResources().filter(e=>this.resourceMatchesCategory(e,r)),s=K[i.icon]||K.globe;t.hidden=!1,t.style.removeProperty(`display`),n&&(n.hidden=!0,n.style.display=`none`),t.style.setProperty(`--cat-accent`,i.color);let c=this.mobileResourceCategoryReturnView===`feed`;t.innerHTML=`
            <button type="button" class="resource-category-detail-back" data-resource-detail-back aria-label="${c?`Back to home`:`Back to help categories`}">
                <span aria-hidden="true">&larr;</span>
                ${c?`<span class="en-text">Back to home</span>
                       <span class="es-text">Volver al inicio</span>`:`<span class="en-text">Back</span>
                       <span class="es-text">Atrás</span>`}
            </button>
            <div class="resource-category-detail-title">
                <span class="resource-category-detail-icon" style="background:${i.color}" aria-hidden="true">${s}</span>
                <div class="resource-category-detail-text">
                    <h2>
                        <span class="en-text">${this.escapeHtml(i.labelEn)}</span>
                        <span class="es-text">${this.escapeHtml(i.labelEs)}</span>
                    </h2>
                    <p>
                        <span class="en-text">${this.getResourceCountText(o.length,`en`)}</span>
                        <span class="es-text">${this.getResourceCountText(o.length,`es`)}</span>
                    </p>
                </div>
            </div>
        `;let l=t.querySelector(`[data-resource-detail-back]`);l&&l.addEventListener(`click`,()=>{if(this.mobileResourceCategoryReturnView===`feed`){this.switchView(`feed`,{preserveResourceNavigation:!1}),N(0);return}this.switchResourceCategory(`all`)})}renderResourceList(e){let t=document.getElementById(`resourcesList`),n=document.getElementById(`resourceEmptyState`),r=document.getElementById(`resourceSortBar`);if(!t||!n)return;let i=this.currentResourceCategory&&this.currentResourceCategory!==`all`||this.resourceSearchQuery&&this.resourceSearchQuery.trim()!==``;if(this.renderResourceCategoryDetailHeader(i),!i){t.innerHTML=``,t.style.display=`none`,t.setAttribute(`aria-hidden`,`true`),n.style.display=`none`,r&&(r.hidden=!0);return}t.style.display=``,t.setAttribute(`aria-hidden`,`false`),r&&(r.hidden=!1);let a=this.currentResourceCategory===`all`?e:e.filter(e=>this.resourceMatchesCategory(e,this.currentResourceCategory));if(a=this.filterResourcesBySearch(a,this.resourceSearchQuery),a=this.sortResources(a,this.resourceSortMode),a.length===0){t.innerHTML=``,t.style.display=`none`,n.innerHTML=this.resourceSearchQuery&&this.resourceSearchQuery.trim()!==``?`<h3>No results found</h3><p>Try a different search term or clear filters.</p><p class="empty-state-bilingual">No se encontraron resultados. Pruebe un término diferente o borre los filtros.</p>`:e.length===0?`<h3>No help links published yet</h3><p>Advisors can add quick links in the admin portal so they appear here for students.</p>`:`<h3>No help links in this category</h3><p>Try another category to see more support links.</p>`,n.style.display=`block`;return}n.style.display=`none`;let o=window.matchMedia(`(max-width: 767px)`).matches&&this.currentResourceCategory&&this.currentResourceCategory!==`all`,s=o?B[this.currentResourceCategory]:null;t.innerHTML=a.map(e=>o?this.createHelpResourceCard(e,s):this.createResourceCard(e)).join(``)}filterResourcesBySearch(e,t){if(!t||t.trim()===``)return e;let n=t.toLowerCase().trim();return e.filter(e=>{let{titleEn:t,titleEs:r}=this.getResourceTitles(e),i=e.description||``,a=this.getResourceCategoryKey(e),o=this.getResourceServices(e).join(` `);return t.toLowerCase().includes(n)||r.toLowerCase().includes(n)||i.toLowerCase().includes(n)||o.toLowerCase().includes(n)||a.toLowerCase().includes(n)})}isResourceFree(e){if(e.isFree===!0||e.free===!0)return!0;let t=[e.highlights,e.description,e.title,e.titleEn,e.titleEs].join(` `).toLowerCase();return/\bfree\b|\bgratis\b|\bgratuito\b/.test(t)}isResourceWalkIn(e){if(e.isWalkIn===!0||e.walkIn===!0)return!0;let t=[e.highlights,e.description,e.title,e.titleEn,e.titleEs].join(` `).toLowerCase();return/walk[\s-]?in|sin cita|drop[\s-]?in/.test(t)}isResourceSpanishSpoken(e){if(Array.isArray(e.languages)){let t=e.languages.join(` `).toLowerCase();if(/spanish|español|espanol/.test(t))return!0}if(e.bilingual===!0)return!0;let t=[e.highlights,e.description].join(` `).toLowerCase();return/spanish|español|espanol|se habla/.test(t)}isDefaultLanguageSet(e){if(!Array.isArray(e))return!1;let t=e.map(e=>String(e||``).trim().toUpperCase()).filter(Boolean);return t.length===2?t.includes(`ENG`)&&t.includes(`ESP`):!1}getDisplayableLanguages(e){if(!e)return[];let t=Array.isArray(e.languages)?e.languages:String(e.languages||``).split(`,`).map(e=>e.trim()).filter(Boolean);return this.isDefaultLanguageSet(t)?[]:t}getResourceCardSummaryHtml(e){if(!e)return``;let t=(e.description||``).trim(),n=(e.summaryEs||``).trim();if(!t&&!n)return``;let r=u(t||n),i=u(n||t);return!r&&!i?``:`<p class="mobile-resource-card__summary">
            <span class="en-text">${this.escapeHtml(r)}</span>
            <span class="es-text">${this.escapeHtml(i)}</span>
        </p>`}isResourceOpenNow(e){let t=(e.hours||e.hoursOfOperation||e.schedule||``).toLowerCase().trim();if(!t)return;if(/24\s*\/\s*7|24\s*hours|open\s*24|any\s*time|anytime|always\s*open|24\s*hr/.test(t))return!0;let n=new Date,r=n.getDay(),i=n.getHours()*60+n.getMinutes(),a={sun:0,sunday:0,mon:1,monday:1,tue:2,tues:2,tuesday:2,wed:3,wednesday:3,thu:4,thur:4,thurs:4,thursday:4,fri:5,friday:5,sat:6,saturday:6},o=e=>{let t=e.trim().match(/^(\d{1,2})(?::(\d{2}))?\s*(am|pm)?$/i);if(!t)return null;let n=parseInt(t[1],10),r=parseInt(t[2]||`0`,10),i=(t[3]||``).toLowerCase();return i===`pm`&&n!==12&&(n+=12),i===`am`&&n===12&&(n=0),n*60+r},s=!1,c=t.split(/[,;|]/);for(let e of c){let t=e.match(/([a-z]+(?:[\s-][a-z]+)?)[:\s]*([\d:]+\s*(?:am|pm)?)\s*[-–]\s*([\d:]+\s*(?:am|pm)?)/i);if(!t)continue;let n=t[1].trim().toLowerCase(),c=o(t[2]),l=o(t[3]);if(c===null||l===null)continue;let u=n.split(/[-–]/).map(e=>a[e.trim()]),d=u[0]??-1,f=u[1]??d;if(d!==-1&&(s=!0,!(r<d||r>f))){if(l>c){if(i>=c&&i<l)return!0}else if(i>=c||i<l)return!0}}return s?!1:void 0}getResourceBadgesHtml(e){let t=[];this.isResourceFree(e)&&t.push(`<span class="badge badge--free"><span class="en-text">Free</span><span class="es-text">Gratis</span></span>`),this.isResourceWalkIn(e)&&t.push(`<span class="badge badge--walkin"><span class="en-text">Walk-in</span><span class="es-text">Sin cita</span></span>`);let n=this.isResourceOpenNow(e);return n===!0?t.push(`<span class="badge badge--open"><span class="en-text">Open now</span><span class="es-text">Abierto</span></span>`):n===!1&&t.push(`<span class="badge badge--closed"><span class="en-text">Closed</span><span class="es-text">Cerrado</span></span>`),t.length===0?``:`<div class="resource-badges-container">${t.join(``)}</div>`}formatCompactAddress(e=``){let t=e.split(`,`).map(e=>e.trim()).filter(Boolean);return t.length>=2?`${t[0]} · ${t[1].replace(/\s+[A-Z]{2}(\s+\d{5}(?:-\d{4})?)?$/i,``).trim()||t[1]}`:e.trim()}getResourceSheetSubtitle(e){let{titleEn:t}=this.getResourceTitles(e),n=(e.company||``).trim(),r=(e.address||``).trim(),i=r?this.formatCompactAddress(r):``;if(i)return n&&n!==t?`${n} · ${i.split(` · `).pop()}`:i;if(n&&n!==t)return n;let a=(e.description||``).trim();if(!a)return``;if(a.length<=72)return a;let o=a.slice(0,72),s=o.lastIndexOf(` `);return`${(s>40?o.slice(0,s):o).trim()}…`}getResourceCountNoun(e,t=`en`){return t===`es`?e===1?`recurso`:`recursos`:e===1?`resource`:`resources`}getResourceCountText(e,t=`en`){return`${e} ${this.getResourceCountNoun(e,t)}`}renderResourcesDesktop(e){let t=document.getElementById(`desktopCategoryNav`),n=document.getElementById(`resourcesDesktopSections`),r=document.getElementById(`resourceDesktopEmptyState`);if(!t||!n)return;let i=document.getElementById(`searchInput`)?.value||document.getElementById(`desktopTopbarSearchInput`)?.value||``,a=this.filterResourcesBySearch(e,i),o={};H.forEach(e=>{o[e]=[]}),a.forEach(e=>{let t=this.getResourceCategoryKey(e);o[t]&&o[t].push(e)});let s=this.currentDesktopResourceTopic||`all`;t.innerHTML=`
            <button
                type="button"
                class="desktop-cat-btn desktop-cat-btn--all${s===`all`?` active`:``}"
            ...
            >
                ...
                ${a.length>0?`<span class="desktop-cat-count" style="background:#e0e7ff;color:#0a1d3a">${a.length}</span>`:``}
            </button>
        `+H.map(e=>{let t=B[e];if(!t)return``;let n=(o[e]||[]).length,r=K[t.icon]||K.globe;return`
                <button
                    type="button"
                    class="desktop-cat-btn${s===e?` active`:``}"
                    data-desktop-cat="${e}"
            ...
            `}).join(``);let c=e=>{this.currentDesktopResourceTopic=e||`all`,t.querySelectorAll(`.desktop-cat-btn`).forEach(e=>{let t=e.dataset.desktopCat||`all`;e.classList.toggle(`active`,t===this.currentDesktopResourceTopic)})};t.querySelectorAll(`.desktop-cat-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.desktopCat;if(!t)return;c(t);let r=parseInt(getComputedStyle(document.documentElement).getPropertyValue(`--app-header-offset`)||`70`,10);if(t===`all`){let e=n.closest(`.resources-desktop-main`)||n;N(window.scrollY+e.getBoundingClientRect().top-r-16);return}let i=document.getElementById(`desktop-section-${t}`);i&&N(window.scrollY+i.getBoundingClientRect().top-r-16)})});let l=H.filter(e=>(o[e]||[]).length>0);if(l.length===0){n.innerHTML=``,r&&(r.style.display=`block`);return}r&&(r.style.display=`none`),n.innerHTML=l.map(e=>{let t=B[e];if(!t)return``;let n=o[e],r=K[t.icon]||K.globe,i=n.map(e=>this.createHelpResourceCard(e,t)).join(``);return`
                <section class="desktop-resource-section" id="desktop-section-${e}" style="--cat-accent:${t.color}">
                    <div class="desktop-section-header">
                        <span class="desktop-section-icon" style="background:${t.color}" aria-hidden="true">${r}</span>
            ...
            `}).join(``)}handleResourceSpeech(e,t){if(!window.speechSynthesis)return;if(t.classList.contains(`speaking`)){window.speechSynthesis.cancel(),t.classList.remove(`speaking`),t.setAttribute(`aria-label`,`Read aloud`);return}window.speechSynthesis.cancel(),document.querySelectorAll(`.resource-audio-btn.speaking`).forEach(e=>{e.classList.remove(`speaking`),e.setAttribute(`aria-label`,`Read aloud`)});let n=document.documentElement.getAttribute(`data-lang`)===`ES`||document.body.classList.contains(`lang-es`)?`es-US`:`en-US`,r=new SpeechSynthesisUtterance(e);r.lang=n;let i=window.speechSynthesis.getVoices(),a=i.find(e=>e.lang===n)||i.find(e=>e.lang.startsWith(n.split(`-`)[0]));a&&(r.voice=a),t.classList.add(`speaking`),t.setAttribute(`aria-label`,`Stop reading`),r.onend=()=>{t.classList.remove(`speaking`),t.setAttribute(`aria-label`,`Read aloud`)},r.onerror=()=>{t.classList.remove(`speaking`),t.setAttribute(`aria-label`,`Read aloud`)},window.speechSynthesis.speak(r)}sortResources(e,t){let n=[...e];switch(t){case`newest`:return n.sort((e,t)=>{let n=this.getTimestampValue(e.datePosted||e.createdAt);return this.getTimestampValue(t.datePosted||t.createdAt)-n});case`az`:return n.sort((e,t)=>{let{titleEn:n}=this.getResourceTitles(e),{titleEn:r}=this.getResourceTitles(t);return n.localeCompare(r)});default:return n.sort((e,t)=>{let n=this.getResourceOrder(e),r=this.getResourceOrder(t);return n===r?this.getTimestampValue(t.datePosted||t.createdAt)-this.getTimestampValue(e.datePosted||e.createdAt):n-r})}}switchResourceCategory(e){this.currentResourceCategory=e,this.renderResourcesSections(this.getPublishedResources())}normalizeResourceCategoryKey(e){return{job:`jobs`,childcare:`family`,money:`money`,esol:`esol`,college:`college`,"legal-aid":`legal-aid`}[e]||e}scrollToDesktopResourceSection(e){if(!e||e===`all`)return;let t=document.getElementById(`desktopCategoryNav`);t&&t.querySelectorAll(`.desktop-cat-btn`).forEach(t=>{t.classList.toggle(`active`,t.dataset.desktopCat===e)});let n=parseInt(getComputedStyle(document.documentElement).getPropertyValue(`--app-header-offset`)||`70`,10),r=document.getElementById(`desktop-section-${e}`);r&&N(window.scrollY+r.getBoundingClientRect().top-n-16)}navigateToResourceCategory(e,t={}){let n=this.normalizeResourceCategoryKey(e),r=window.matchMedia(`(min-width: 768px)`).matches,i=this.currentView;r&&t.expandDesktop&&n&&n!==`all`&&this.expandedDesktopResourceSections.add(n),r?this.currentDesktopResourceTopic=n:(this.currentResourceCategory=n,this.mobileResourceCategoryReturnView=i===`resources`?`categories`:`feed`),this.switchView(`resources`,{preserveResourceNavigation:!0,skipRender:!0}),this.renderResourcesSections(this.getPublishedResources()),r&&requestAnimationFrame(()=>{this.scrollToDesktopResourceSection(n)})}openResourceShortcut(e){this.navigateToResourceCategory(e)}setFeedCategory(e=`all`){let t=this.normalizeFeedCategory(e);this.currentView!==`feed`&&this.switchView(`feed`,{skipRender:!0,preserveDetail:!0}),this.currentFeedCategory=t,this.selectedCategories=t===`all`?[]:[t],this.updateFeedCategoryHeader(),this.updateActiveCategoryState(),this.updateSearchLayerCatState(t),this.updateFilterCount(),this.applyFilters()}normalizeFeedCategory(e){return t(e)}openResourceDetailSheet(e,t={}){let n=B[e],r=document.getElementById(`catDetailSheet`),i=document.getElementById(`catDetailTitle`),a=document.getElementById(`catDetailIcon`),o=document.getElementById(`catOrgList`);if(!n||!r||!o)return;let s=this.getPublishedResources().filter(t=>this.getResourceCategoryKey(t)===e),c=window.matchMedia(`(max-width: 767px)`).matches,l=!t.showAll,u=l?s.slice(0,3):s,d=K[n.icon]||K.globe;i&&(i.innerHTML=`
                <span class="en-text">${this.escapeHtml(n.labelEn)}</span>
                <span class="es-text">${this.escapeHtml(n.labelEs)}</span>
                <small>
            ...
            `),a&&(a.style.background=n.color,a.innerHTML=d),r.style.setProperty(`--cat-accent`,n.color);let f=l&&s.length>u.length?this.createResourceSheetShowAllButton(e,n,s.length):``;o.innerHTML=u.length>0?u.map(e=>c?this.createHelpResourceSheetRow(e,n):this.createHelpResourceCard(e,n)).join(``):`
        ...
        `}createResourceDetailCard(e,t,n={}){let{titleEn:r}=this.getResourceTitles(e),i=n.compact===!0,a=i?this.getResourceSheetSubtitle(e):e.description||``,o=a?i?this.escapeHtml(a):this.formatRichTextInline(e.description||``):``,s=this.getResourceUrl(e),c=e.websiteLabel||this.formatLinkLabel(s,this.getResourceCategoryKey(e)),l=e.phone||``,u=e.tel||(l?`tel:${l.replace(/[^0-9+]/g,``)}`:``),d=e.address||``,f=e.mapUrl||(d?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(d)}`:``),p=Array.isArray(e.languages)?this.getDisplayableLanguages(e):this.parseResourceHighlights(e.highlights),m=p.length>0?`<div class="cat-org-langs">${p.slice(0,5).map(e=>`<span class="cat-org-lang-tag">${this.escapeHtml(e)}</span>`).join(``)}</div>`:``,h=l&&u?`<a href="${this.escapeAttribute(u)}" class="cat-org-btn cat-org-btn--call">
        ...
        `}scrollElementBelowHeader(e,t={}){if(!e)return;let n=document.querySelector(`header`),r=n?n.getBoundingClientRect().height:0,i=t.gap??20;N(window.scrollY+e.getBoundingClientRect().top-r-i,t.behavior)}getStoryBubbleResources(e){let t=[];return V.forEach(e=>{let n=B[e];n&&t.push({id:`bubble-${e}`,type:`resource`,title:n.labelEn,titleEn:n.labelEn,titleEs:n.labelEs,category:`resource`,resourceCategory:e,resourceIcon:n.icon,isPreviewBubble:!0})}),t}createResourceStoryBubble(e){let{titleEn:t,titleEs:n}=this.getResourceTitles(e),r=e.isPreviewBubble===!0,i=this.getResourceCategoryKey(e),a=this.getResourceUrl(e),o=e.description?this.formatRichTextInline(e.description):``;if(r)return`
                <button
                    type="button"
        ...
        `}createResourceCard(e){let{titleEn:t,titleEs:n}=this.getResourceTitles(e),r=this.getResourceCategoryKey(e),i=this.getResourceCategoryConfig(e),a=e.description?this.formatRichTextInline(e.description):``,o=this.getResourceUrl(e),s=e.resourceLogo||``,c=this.parseResourceHighlights(e.highlights),l=c.length>0?`<span class="resource-card-highlights">
        ...
        `}openResourceFromSheet(e){e&&(this.closeResourceDetailSheet(),this.showBulletinDetail(e))}createHelpResourceSheetRow(e,t){let{titleEn:n}=this.getResourceTitles(e),r=(t||this.getResourceCategoryConfig(e))?.color||`#0a1d3a`,i=(e.address||``).trim(),a=(e.phone||``).trim(),o=this.getResourceServices(e),s=o.length?this.getResourceServiceChipsHtml(e,{max:2}):``,c=``;o.length||(c=i?this.formatCompactAddress(i):a||this.getResourceSheetSubtitle(e));let l=e.resourceLogo||``,u=l?`<img src="${this.escapeAttribute(l)}" alt="" loading="lazy">`:`<span class="help-sheet-row__icon-fallback" style="background:${r}" aria-hidden="true">${this.getResourceIconSvg(e)}</span>`;return`
            <article class="help-sheet-row" style="--cat-accent:${r}" data-resource-id="${this.escapeAttribute(e.id||``)}">
                <div class="help-sheet-row__mark">${u}</div>
                <div class="help-sheet-row__copy">
                    <h3 class="help-sheet-row__title">${this.escapeHtml(n)}</h3>
                    ${s||(c?`<p class="help-sheet-row__meta">${this.escapeHtml(c)}</p>`:``)}
                </div>
                <button type="button"
                        class="help-sheet-row__more"
                        data-resource-more="${this.escapeAttribute(e.id||``)}"
                        aria-label="More info about ${this.escapeAttribute(n)}">
        ...
        `}createHelpResourceCard(e,t){let{titleEn:n,titleEs:r}=this.getResourceTitles(e),i=this.getResourceCategoryKey(e),a=(t||this.getResourceCategoryConfig(e))?.color||`#0a1d3a`,o=this.getResourceUrl(e),s=o&&o!==`#`,c=(e.phone||``).trim(),l=e.tel||(c?`tel:${c.replace(/[^0-9+]/g,``)}`:``),u=(e.address||``).trim(),d=e.mapUrl||(u?`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(u)}`:``),f=e.resourceLogo||``,p=f?`<img src="${this.escapeAttribute(f)}" alt="" loading="lazy">`:`<span class="mobile-resource-card__icon-fallback" style="background:${a}" aria-hidden="true">${this.getResourceIconSvg(e)}</span>`;this.getPostDescription(e);let m=this.getResourceServiceChipsHtml(e),h=(e.hours||``).trim(),g=h?`<p class="mobile-resource-card__hours">${this.escapeHtml(h)}</p>`:``,_=this.getResourceBadgesHtml(e),v=this.getDisplayableLanguages(e),y=v.length?`<div class="mobile-resource-card__langs">${v.slice(0,4).map(e=>`<span class="mobile-resource-card__lang">${this.escapeHtml(e)}</span>`).join(``)}</div>`:``,b=window.matchMedia(`(min-width: 768px)`).matches,x=c&&b?`<p class="mobile-resource-card__phone">
                ...
                </p>`:``,S=[c&&l&&!b?`<a class="mobile-resource-card__btn mobile-resource-card__btn--primary"
                  href="${this.escapeAttribute(l)}"
                  data-analytics-action="resource_call"
                  data-analytics-post-id="${this.escapeAttribute(e.id||``)}"
                  data-analytics-category="${this.escapeAttribute(i)}"
                  data-analytics-content-type="resource"
                  aria-label="Call ${this.escapeAttribute(n)}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M5.25 7.75c0 5.1 5.9 11 11 11h1.75a1 1 0 0 0 1-1v-3.2a1 1 0 0 0-.78-.98l-3.14-.7a1 1 0 0 0-.96.29l-.92.98a13.84 13.84 0 0 1-4.34-4.34l.98-.92a1 1 0 0 0 .29-.96l-.7-3.14A1 1 0 0 0 8.45 4H5.25a1 1 0 0 0-1 1v2.75Z"/></svg>
                    <span class="en-text">Call</span>
                    <span class="es-text">Llamar</span>
                </a>`:``,s?`<a class="mobile-resource-card__btn mobile-resource-card__btn--secondary"
                  href="${this.escapeAttribute(o)}"
                  target="_blank"
                  rel="noopener"
                  data-analytics-action="resource_open"
                  ...
                  data-analytics-category="${this.escapeAttribute(i)}"
                  data-analytics-content-type="resource"
                  aria-label="Open ${this.escapeAttribute(n)} website">
                ...
                </a>`:``,d?`<a class="mobile-resource-card__btn mobile-resource-card__btn--secondary mobile-resource-card__btn--directions"
                  href="${this.escapeAttribute(d)}"
                  target="_blank"
                  rel="noopener"
                  data-analytics-action="resource_open"
                  data-analytics-post-id="${this.escapeAttribute(e.id||``)}"
                  data-analytics-category="${this.escapeAttribute(i)}"
                  data-analytics-content-type="resource"
                  aria-label="Get directions to ${this.escapeAttribute(n)}">
                ...
                </a>`:``].filter(Boolean),C=S.length===1?` mobile-resource-card__actions--single`:S.length>=3?` mobile-resource-card__actions--triple`:``,w=S.length?`<div class="mobile-resource-card__actions${C}">${S.join(``)}</div>`:``,T=u?`<p class="mobile-resource-card__address">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 21s6.25-5.9 6.25-11.1a6.25 6.25 0 1 0-12.5 0C5.75 15.1 12 21 12 21Z"/><circle cx="12" cy="9.75" r="2.5"/></svg>
                    ${this.escapeHtml(u)}
                </p>`:``,E=this.escapeHtml(n).replace(/'/g,`&#39;`);return`
            <article class="mobile-resource-card mobile-resource-card--${i}"
                     style="--cat-accent:${a}"
                     data-resource-id="${this.escapeAttribute(e.id||``)}">
                <button type="button"
                        class="mobile-resource-card__share"
                        onclick="shareBulletin('${e.id||``}','${E}')"
                        aria-label="Share ${this.escapeAttribute(n)}">
                ...
                <div class="mobile-resource-card__logo-tile">${p}</div>
                <div class="mobile-resource-card__body">
                    <div class="mobile-resource-card__heading">
                        <div class="mobile-resource-card__title-row">
                            <h3 class="mobile-resource-card__title">${this.escapeHtml(n)}</h3>
                            ${_}
                        </div>
                        ${r&&r!==n?`<p class="mobile-resource-card__subtitle">${this.escapeHtml(r)}</p>`:``}
                    </div>
                    ${this.getResourceCardSummaryHtml(e)}
                    ${m}
                    ${g}
                    ${y}
                    ${x}
        ...
        `}getResourceServices(e,t=5){return e?Array.isArray(e.services)&&e.services.length?e.services.map(e=>String(e||``).trim()).filter(Boolean).slice(0,t):this.parseResourceHighlights(e.highlights,t):[]}getResourceServiceChipsHtml(e,t={}){let n=t.max??5,r=this.getResourceServices(e,n);return r.length?`<div class="resource-service-chips">${r.map(e=>`<span class="resource-service-chip"><span class="en-text">${this.escapeHtml(e)}</span><span class="es-text">${this.escapeHtml(W(e))}</span></span>`).join(``)}</div>`:``}parseResourceHighlights(e,t=5){return e?Array.isArray(e)?e.slice(0,t):typeof e==`string`?e.split(`,`).map(e=>e.trim()).filter(Boolean).slice(0,t):[]:[]}getPostBulletins(e=this.bulletins){return e.filter(e=>!this.isResourceBulletin(e))}isCalendarEventBulletin(e){if(!e||this.isResourceBulletin(e))return!1;let t=e.dateType;if(t!==`event`&&t!==`range`&&t!==`sessions`)return!1;let n=!!((e.description||``).trim()||(e.company||``).trim()||(e.contact||``).trim()||(e.eventLink||``).trim()||e.image||e.pdfUrl);return e.category===`announcement`&&!n}getPublishedResources(){return[...this.bulletins].filter(e=>this.isResourceBulletin(e)&&e.isPublished!==!1).sort((e,t)=>{if(+!!e.isPinned!=+!!t.isPinned)return!!t.isPinned-+!!e.isPinned;let n=this.getResourceOrder(e),r=this.getResourceOrder(t);return n===r?this.getTimestampValue(t.datePosted||t.createdAt)-this.getTimestampValue(e.datePosted||e.createdAt):n-r})}isResourceBulletin(e){return e&&e.type===`resource`}getResourceOrder(e){if(e.resourceOrder===``||e.resourceOrder===null||e.resourceOrder===void 0)return 2**53-1;let t=Number(e.resourceOrder);return Number.isFinite(t)?t:2**53-1}parseStoredYmdLocal(e){if(!e||typeof e!=`string`)return null;let t=e.trim().match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!t)return null;let n=Number(t[1]),r=Number(t[2])-1,i=Number(t[3]),a=new Date(n,r,i);return Number.isNaN(a.getTime())?null:a}getTimestampValue(e){if(!e)return 0;if(typeof e.toDate==`function`)return e.toDate().getTime();if(typeof e==`string`){let t=this.parseStoredYmdLocal(e);if(t)return t.getTime()}let t=new Date(e);return Number.isNaN(t.getTime())?0:t.getTime()}getFeedSortTimestamp(e){let t=this.getTimestampValue(e.datePosted||e.createdAt);return!e||e.dateType!==`sessions`?t:s(this.getBulletinEventSessions(e),t)}compareFeedPosts(e,t){let n=this.getFeedSortTimestamp(e),r=this.getFeedSortTimestamp(t);if(r!==n)return r-n;if(e.dateType===`sessions`&&t.dateType===`sessions`){let n=f(this.getBulletinEventSessions(e)),r=f(this.getBulletinEventSessions(t));if(n!==r)return n-r}return this.getTimestampValue(t.datePosted||t.createdAt)-this.getTimestampValue(e.datePosted||e.createdAt)}formatPostedDate(e){let t=this.getTimestampValue(e);return t?new Date(t).toLocaleDateString():`Recently posted`}getResourceCategoryKey(e){return B[e.resourceCategory]?e.resourceCategory:`resource`}getResourceCategoryKeys(e){let t=[e.resourceCategory,e.category,...Array.isArray(e.categories)?e.categories:[],...Array.isArray(e.tags)?e.tags:[]];return typeof e.categories==`string`&&t.push(...e.categories.split(`,`)),typeof e.tags==`string`&&t.push(...e.tags.split(`,`)),[...new Set(t.filter(Boolean).map(e=>{let t=this.normalizeFeedCategory(String(e).trim().toLowerCase());return t===`job`?`jobs`:t===`childcare`?`family`:t}).filter(Boolean))]}resourceMatchesCategory(e,t){let n=this.normalizeFeedCategory(t),r=n===`job`?`jobs`:n===`childcare`?`family`:n;return this.getResourceCategoryKeys(e).includes(r)}getBulletinCategoryKeys(e){let t=[e.category,e.classType,...Array.isArray(e.categories)?e.categories:[],...Array.isArray(e.tags)?e.tags:[]];typeof e.categories==`string`&&t.push(...e.categories.split(`,`)),typeof e.tags==`string`&&t.push(...e.tags.split(`,`));let n=t.filter(Boolean).map(e=>this.normalizeFeedCategory(String(e).trim().toLowerCase())).filter(e=>e&&e!==`all`);return[...new Set(n)]}bulletinMatchesCategory(e,t){let n=this.normalizeFeedCategory(t);return this.getBulletinCategoryKeys(e).includes(n)}getResourceCategoryConfig(e){return B[this.getResourceCategoryKey(e)]||{labelEn:`Resource`,labelEs:`Recurso`,icon:`globe`}}getResourceTitles(e){let t=this.getResourceCategoryConfig(e),n=e.titleEn||e.title||t.labelEn;return{titleEn:n,titleEs:e.titleEs||e.subtitle||t.labelEs||n}}getResourceUrl(e){let t=(e.url||e.eventLink||``).trim();return t?/^https?:\/\//i.test(t)?t:`https://${t}`:`#`}getResourceIconSvg(e){let t=this.getResourceCategoryConfig(e);return K[e.resourceIcon&&e.resourceIcon!==`auto`?e.resourceIcon:t.icon]||K.globe}handleHashRouting(){let e=window.location.hash;if(e&&e.startsWith(`#bulletin-`)){let t=e.replace(`#bulletin-`,``);this.currentView!==`feed`&&this.switchView(`feed`,{skipRender:!0,preserveDetail:!0}),this.focusBulletinFromHash(),this.showBulletinDetail(t)}else this.closeBulletinDetail(!1)}focusBulletinFromHash(){let e=window.location.hash;if(!e||!e.startsWith(`#bulletin-`))return;let t=document.querySelector(e);t&&(t.classList.add(`hash-highlight`),t.scrollIntoView({behavior:M(),block:`center`}),setTimeout(()=>{t.classList.remove(`hash-highlight`)},2800),this.lastHashHighlight=e)}showBulletinDetail(e){this.activeDetailBulletinId=e;let t=document.getElementById(`bulletinDetailModal`),n=document.getElementById(`bulletinDetailBody`);if(!t||!n)return;let r=this.bulletins.find(t=>t.id===e)||R.find(t=>t.id===e);r?(r.isSchoolCalendarAnchor||L(`detail_open`,{postId:r.id,category:r.category,contentType:r.type||`post`}),n.innerHTML=this.renderBulletinDetail(r)):n.innerHTML=`<div class="detail-card"><p>This bulletin is no longer available.</p></div>`,t.style.display=`flex`,t.setAttribute(`aria-hidden`,`false`),document.body.classList.add(`modal-open`)}closeBulletinDetail(e=!0){this.activeDetailBulletinId=null;let t=document.getElementById(`bulletinDetailModal`);t&&(t.style.display=`none`,t.setAttribute(`aria-hidden`,`true`),document.body.classList.remove(`modal-open`),document.body.style.overflow=``,e&&window.location.hash.startsWith(`#bulletin-`)&&history.replaceState(null,``,window.location.pathname+window.location.search))}showDayEvents(e){let t=document.getElementById(`bulletinDetailModal`),n=document.getElementById(`bulletinDetailBody`);if(!t||!n)return;let r=e.map(e=>{let t=this.isBulletinExpired(e);return`
                <div class="day-event-item ${t?`expired`:``}" onclick="event.stopPropagation(); bulletinBoard.showBulletinDetail('${e.id}')">
                    <div class="day-event-header">
                        <h3 class="day-event-title">${this.escapeHtml(this.getPostTitle(e))}</h3>
        ...
        </svg>`}createBulletinCard(e){let t=this.getCatMeta(e.category),n=this.isApplicationDeadline(e),r=this.isBulletinExpired(e),i=this.formatPostedDate(e.datePosted),a=this.getPostTitle(e),o=a.length>40?a.substring(0,38)+`…`:a,s=l(this.getPostDescription(e),150),c=this.escapeHtml(s),u=this.formatFeedDateDisplayHtml(e),d=`window.bulletinBoard && window.bulletinBoard.showBulletinDetail('${e.id}')`,f=(document.body.getAttribute(`data-lang`)||`EN`)===`ES`&&e.imageEs?e.imageEs:e.image,p=!!f,m=`
      <div class="pc__chip-bar" style="--chip-accent:${t.accent};--chip-tint:${t.tint}">
        <div class="pc__chips" role="list" aria-label="Post labels">
          ${r?`<span class="pc__chip pc__chip--expired" role="listitem">⏰ Expired</span>`:``}
          <span class="pc__chip pc__chip--category" role="listitem">
            <span class="pc__chip-emoji" aria-hidden="true">${t.emoji}</span>
            <span class="en-text">${this.escapeHtml(t.label.toUpperCase())}</span>
            <span class="es-text">${this.escapeHtml(t.labelEs.toUpperCase())}</span>
          </span>
        </div>
      </div>`;return`
    <article class="pc ${r?`pc--expired`:``}" id="bulletin-${e.id}" data-bulletin-id="${e.id}" onclick="${d}" role="button" tabindex="0" style="cursor:pointer">
      ${m}
      <div class="pc__top ${p?`pc__top--image`:``}" style="background:${p?`#f8fafc`:t.grad}">
        ${p?`<div class="pc__image-stage"><img class="pc__poster-image" src="${this.escapeAttribute(f)}" alt=""></div>`:`<div class="pc__icon-wrap"><div class="pc__icon-box" style="background:${t.accent}">${this.getCardIconSvg(e.category)}</div></div>
        <div class="pc__title-overlay">${this.escapeHtml(o)} —</div>`}
      </div>

      <div class="pc__body">
        <h3 class="pc__title">${this.escapeHtml(a)}</h3>
        <p class="pc__desc">${c}</p>

        ${u?`
        <div class="pc__date ${n&&!r?`pc__date--urgent`:``}">
        ...
        <div class="pc__footer">
          <div class="pc__foot-left">
            <span class="pc__foot-name">${this.escapeHtml(e.advisorName||`Advisor`)} · ${i}</span>
          </div>
          <span class="pc__open-btn" style="color:${t.accent}">Open →</span>
        </div>
      </div>
    </article>
        `}_unused_createBulletinCard_v1(e){this.formatPostedDate(e.datePosted),this.isApplicationDeadline(e);let t=this.isBulletinExpired(e);return this.renderFormattedDescription(e.description||``,e.id,!0),`
        ...
        `}renderBulletinDetail(e){let t=this.getCatMeta(e.category),n=this.formatPostedDate(e.datePosted),r=this.getDetailImportantDate(e),i=(e.dateType===`sessions`?this.getBulletinEventSessions(e).length:0)>1,a=r&&r.kind===`deadline`&&this.isDeadlineClose(r.raw),o=this.isBulletinExpired(e),s=(e.advisorName||`?`).charAt(0).toUpperCase(),c=r&&(r.kind===`event`||r.kind===`start`),l=e.isSchoolCalendarAnchor?`<strong>School Calendar</strong>`:c?`<strong>${this.escapeHtml(e.advisorName||`Advisor`)}</strong>`:`<strong>${this.escapeHtml(e.advisorName||`Advisor`)}</strong> · ${n}`,u=this.getPostDescription(e),d=this.isResourceBulletin(e),f=d?this.getResourceServiceChipsHtml(e):``,p=u?this.renderFormattedDescription(u,`${e.id}-detail`):``,m=!d&&p?`<div class="post-detail-description">${p}</div>`:``,h=d&&p?`<div class="post-detail-description post-detail-description--notes"><p class="post-detail-notes-label"><span class="en-text">Additional notes</span><span class="es-text">Notas adicionales</span></p>${p}</div>`:``,g=[e.classType?this.getClassTypeDisplay(e.classType):``,e.company||``,e.eventLocation||``].filter(Boolean).slice(0,3),_=this.getDetailContactAction(e),v=this.hasDetailInfoGridContent(e),y=this.isResourceBulletin(e)?this.getResourceUrl(e):``,b=y&&y!==`#`?y:e.eventLink||``,x=(document.body.getAttribute(`data-lang`)||`EN`)===`ES`&&e.imageEs?e.imageEs:e.image,S=x?`<button type="button" class="post-detail-hero-zoom lightbox-trigger" data-lightbox-src="${this.escapeAttribute(x)}" aria-label="View full size flyer">
                <img class="post-detail-hero-image" src="${this.escapeAttribute(x)}" alt="">
            ...
            </button>`:`<div class="post-detail-hero-art">
            ...
            <article class="post-detail-page" style="--detail-accent:${t.accent};--detail-tint:${t.tint}">
                ...
                <section class="post-detail-panel">
                    ...
                    <h2>${this.escapeHtml(this.getPostTitle(e))}</h2>
                    ${f}
                    ${o?`<p class="post-detail-expired">Expired</p>`:``}
                    <div class="post-detail-author">
                        <span class="post-detail-avatar" style="background:${t.accent}">${this.escapeHtml(s)}</span>
                        <span>${l}</span>
                    </div>
                    ${r?`
                        <div class="post-detail-date ${a&&!o?`post-detail-date--urgent`:``}${i?` post-detail-date--sessions`:``}">
                            ...
                            <div class="post-detail-date-copy">
                                <strong>${i?`Session dates`:`Important date`}</strong>
                                ${i?this.buildSessionDatesDetailHtml(e):`<small>${this.escapeHtml(r.label)}</small>`}
                            </div>
                        </div>
                    `:``}
                    ${m}
                    ...
                    ${v?`
                        <div class="post-detail-info-grid" style="margin-top: 24px; display: grid; gap: 16px; background: #f8fafc; padding: 20px; border-radius: 16px; border: 1px solid #e2e8f0;">
                            ...
                            ${this.getDisplayableLanguages(e).length?`
                                <div style="display: flex; gap: 12px; align-items: flex-start;">
                                    ...
                                    <div>
                                        ...
                                        <div style="display: flex; gap: 6px; margin-top: 6px; flex-wrap: wrap;">
                                            ${this.getLanguageTagsHtml(this.getDisplayableLanguages(e))}
                                        </div>
                                    </div>
                                </div>
                            `:``}
                    ...
                    ${g.length?`<div class="post-detail-tags">${g.map(e=>`<span>${this.escapeHtml(e)}</span>`).join(``)}</div>`:``}
                    ${e.contact?`<div class="post-detail-contact-note">${this.escapeHtml(e.contact).replace(/\n/g,`<br>`)}</div>`:``}
                    <div class="post-detail-actions">
                        ${_?`
                            <a href="${this.escapeAttribute(_.href)}" class="post-detail-action post-detail-action--primary">
                                ...
                                <span><strong>${this.escapeHtml(_.label)}</strong><small>${this.escapeHtml(_.value)}</small></span>
                            </a>
                        `:``}
                        ${e.pdfUrl?`
                        ...
                        `:``}
                        ${b?`
                            <a href="${this.escapeAttribute(b)}" target="_blank" rel="noopener" class="post-detail-action post-detail-action--outline" data-analytics-action="link_click" data-analytics-post-id="${this.escapeAttribute(e.id)}" data-analytics-category="${this.escapeAttribute(e.category)}" data-analytics-content-type="post">
                                ...
                                <span><strong>${this.escapeHtml(this.getDetailLinkActionLabel(e.category))}</strong><small>${this.escapeHtml(this.getDisplayHost(b))}</small></span>
                            </a>
                        `:``}
        ...
        `}getDetailImportantDate(e){if(e.dateType===`sessions`){let t=this.expandBulletinDateItems(e);if(!t.length)return null;let n=new Date;n.setHours(0,0,0,0);let r=t.filter(e=>e.date>=n).sort((e,t)=>e.date.getTime()-t.date.getTime())[0]||t[t.length-1];return{raw:r.rawDate,date:r.date,kind:r.kind,label:this.formatSessionDatesDetailLabel(e)}}let t=this.getDatesListItem(e);return t?{raw:t.rawDate,date:t.date,kind:t.kind,label:t.label}:null}getDetailContactAction(e){let t=[e.phone||``,e.contact].filter(Boolean).join(` `).match(/(?:\+?1[\s.-]?)?\(?\d{3}\)?[\s.-]?\d{3}[\s.-]?\d{4}/);if(!t)return null;let n=t[0].replace(/\s+/g,` `).trim(),r=n.replace(/[^0-9+]/g,``),i=e.phoneMode||`call`,a=`Call`,o=`tel:${r}`;return i===`text`?(a=`Text`,o=`sms:${r}`):i===`both`&&(a=`Call or Text`),e.category===`job`&&(a=i===`text`?`Text hiring`:`Call hiring`),{href:o,label:a,value:n}}getLanguageTagsHtml(e){if(!e)return``;let t=Array.isArray(e)?e:String(e).split(`,`).map(e=>e.trim()).filter(Boolean),n={ENG:`English`,ESP:`Español`,POR:`Português`,KRE:`Kreyòl (Haitian Creole)`,ARA:`Arabic`,VIE:`Vietnamese`,CHI:`Chinese`};return t.map(e=>{let t=e.toUpperCase(),r=n[t]||t;return`
            ...
            <article class="detail-card ${t?`expired-bulletin`:``}" id="detail-${e.id}">
                ...
                <div class="detail-body">
                    ${this.getPostDescription(e)?this.renderFormattedDescription(this.getPostDescription(e),`${e.id}-detail`):``}
            ...
            <div class="bulletin-list-item ${r?`expired-bulletin`:``}">
                ...
                <div class="bulletin-list-content">
                    <div class="bulletin-list-header">
                        <div class="bulletin-list-title">${this.escapeHtml(this.getPostTitle(e))}</div>
                    </div>
        ...
        `}expandBulletinDateItems(e){if(e.dateType===`sessions`)return this.getBulletinEventSessions(e).map(t=>{let n=this.parseDateOnly(t.date);return n?{bulletin:e,rawDate:t.date,date:n,kind:`event`,session:t,label:this.getDatesListLabel(e,n,`event`,{session:t})}:null}).filter(Boolean);let t=this.getDatesListItem(e);return t?[t]:[]}getDatesListItem(e){let t=``,n=`date`;if(e.dateType===`deadline`&&e.eventDate?(t=e.eventDate,n=`deadline`):e.dateType===`event`&&e.eventDate?(t=e.eventDate,n=`event`):e.dateType===`range`&&e.startDate?(t=e.startDate,n=`start`):e.eventDate?(t=e.eventDate,n=`event`):e.startDate?(t=e.startDate,n=`start`):e.deadline&&(t=e.deadline,n=`deadline`),!t)return null;let r=this.parseDateOnly(t);return r?{bulletin:e,rawDate:t,date:r,kind:n,label:this.getDatesListLabel(e,r,n)}:null}parseDateOnly(e){if(!e)return null;if(e instanceof Date)return e;if(typeof e.toDate==`function`)return e.toDate();let t=String(e),n=t.includes(`T`)?new Date(t):new Date(`${t}T12:00:00`);return Number.isNaN(n.getTime())?null:n}getDatesListLabel(e,t,n,r={}){let i=this.getLocale(),a=this.getCurrentLang()===`ES`,o=t.toLocaleDateString(i,{weekday:`short`,month:`short`,day:`numeric`}),s=t.toLocaleDateString(i,{weekday:`long`,month:`short`,day:`numeric`}),c=r.session?this.formatTimeRange(r.session.startTime,r.session.endTime):this.formatTimeRange(e.startTime,e.endTime);return n===`deadline`?a?`Postular antes del ${o}`:`Apply by ${o}`:n===`start`?a?`Comienza el ${s}${c?` · ${c}`:``}`:`Starts ${o}${c?` · ${c}`:``}`:`${s}${c?` · ${c}`:``}`}createDatesListCard(e){let{bulletin:t,date:n,kind:r,label:i}=e,a=this.getCatMeta(t.category),o=this.getPostTitle(t),s=this.getLocale(),c=this.getCurrentLang()===`ES`,l=r===`deadline`?c?`LÍM`:`BY`:n.toLocaleDateString(s,{month:`short`}).toUpperCase(),u=n.getDate(),d=r===`deadline`?`#f08b1f`:a.accent;return`
            <article
                class="dates-list-card"
                data-list-date="${`${n.getFullYear()}-${String(n.getMonth()+1).padStart(2,`0`)}-${String(n.getDate()).padStart(2,`0`)}`}"
                style="--date-accent:${a.accent};--date-tint:${a.tint};--date-dot:${d}"
                role="button"
                tabindex="0"
            ...
            >
                ...
                <div class="dates-list-copy">
                    ...
                    <p class="dates-list-label">${r===`start`?this.formatStartDateLabelHtml(n,t):this.escapeHtml(i)}</p>
                </div>
        ...
        `,d}createMonthlyCalendarDay(e,t,n,r={}){let{navigatorMode:i=!1,isoDate:a=``}=r,o=t.length,s=o>0,c=s&&!i?`onclick='window.bulletinBoard && window.bulletinBoard.showDayEventsByIds(${JSON.stringify(t.map(e=>e.id))})'`:``,l=s&&i?`data-calendar-day="${a}"`:``;return`
        ...
        `}createMonthlyBulletinItem(e){let t=this.isApplicationDeadline(e),n=``;return e.dateType&&e.eventDate?n=this.formatDateLocal(e.eventDate):e.deadline&&(n=this.formatDateLocal(e.deadline)),`
            <div class="monthly-bulletin-item" onclick="bulletinBoard.showBulletinDetail('${e.id}')">
                ...
                <div class="monthly-bulletin-title">${this.escapeHtml(this.getPostTitle(e))}</div>
                ${n?`
        ...
        `}createCalendarBulletinItem(e){let t=this.isApplicationDeadline(e),n=``;return e.dateType&&e.eventDate?n=this.formatDateLocal(e.eventDate):e.deadline&&(n=this.formatDateLocal(e.deadline)),`
            <div class="calendar-bulletin-item">
                <div class="calendar-bulletin-title">${this.escapeHtml(this.getPostTitle(e))}</div>
        ...
        `}checkAutoLogin(){}previousMonth(){this.currentCalendarMonth--,this.currentCalendarMonth<0&&(this.currentCalendarMonth=11,this.currentCalendarYear--),console.log(`📅 Previous month:`,this.currentCalendarMonth,this.currentCalendarYear),this.displayBulletins()}nextMonth(){this.currentCalendarMonth++,this.currentCalendarMonth>11&&(this.currentCalendarMonth=0,this.currentCalendarYear++),console.log(`📅 Next month:`,this.currentCalendarMonth,this.currentCalendarYear),this.displayBulletins()}};function J(e,t){if(window.bulletinBoard){let t=window.bulletinBoard.bulletins.find(t=>t.id===e);L(`share_click`,{postId:e,category:t?t.category:``,contentType:t&&t.type||`post`})}Y(t,`${window.location.origin}${window.location.pathname}#bulletin-${e}`)}function Y(e,t){Q();let n=document.createElement(`div`);n.className=`share-modal`,n.innerHTML=`
    ...
    `,document.body.appendChild(n)}function X(e,t,n){let r={whatsapp:`https://wa.me/?text=${t}%20${n}`,facebook:`https://www.facebook.com/sharer/sharer.php?u=${n}`,email:`mailto:?subject=${t}&body=Check out this opportunity: ${n}`,sms:`sms:?body=${t} ${n}`};window.open(r[e],`_blank`),Q()}function Z(){let e=document.getElementById(`shareLink`);e.select(),e.setSelectionRange(0,99999);try{document.execCommand(`copy`);let e=document.querySelector(`.copy-btn`);e.textContent=`Copied!`,e.style.background=`#27ae60`,setTimeout(()=>{e.textContent=`Copy Link`,e.style.background=``},2e3)}catch(e){console.error(`Copy failed:`,e)}}function Q(){let e=document.querySelector(`.share-modal`);e&&e.remove()}window.shareBulletin=J,window.shareVia=X,window.copyLink=Z,window.closeShareModal=Q;var $;document.addEventListener(`DOMContentLoaded`,()=>{$=new q,window.bulletinBoard=$}),m(),k();