import{G as e,H as t,L as n,N as r,R as i,_ as a,c as o,d as s,g as c,h as l,l as u,m as d,n as f,q as p,r as m,s as h,t as g,u as _,v,x as y,z as b}from"./rich-text-cMRJC-u6.js";function x(){return{lightbox:document.getElementById(`imgLightbox`),lightboxImg:document.getElementById(`imgLightboxImg`),closeBtn:document.getElementById(`imgLightboxClose`),backdrop:document.getElementById(`imgLightboxBackdrop`),openBtn:document.getElementById(`imgLightboxOpenBtn`)}}function S(){return document.body.classList.contains(`modal-open`)||document.body.classList.contains(`search-layer-open`)||document.body.classList.contains(`resource-sheet-open`)}function C(){let{lightbox:e}=x();return!!(e&&e.classList.contains(`open`))}function w(e){let{lightbox:t,lightboxImg:n,openBtn:r}=x();!t||!n||!e||(n.classList.remove(`is-tall`),n.src=e,r&&(r.href=e),t.classList.add(`open`),t.setAttribute(`aria-hidden`,`false`),S()||(document.body.style.overflow=`hidden`),n.onload=function(){n.naturalHeight/n.naturalWidth>1.2&&n.classList.add(`is-tall`)})}function T(){let{lightbox:e,lightboxImg:t}=x();!e||!t||(e.classList.remove(`open`),e.setAttribute(`aria-hidden`,`true`),document.body.style.overflow=``,t.src=``,t.classList.remove(`is-tall`))}function E(){let{lightbox:e,closeBtn:t,backdrop:n}=x();e&&(document.addEventListener(`click`,e=>{let t=e.target.closest(`.lightbox-trigger`);!t||!t.dataset.lightboxSrc||(e.preventDefault(),e.stopPropagation(),w(t.dataset.lightboxSrc))}),t&&t.addEventListener(`click`,T),n&&n.addEventListener(`click`,T),document.addEventListener(`keydown`,e=>{e.key===`Escape`&&C()&&(e.stopImmediatePropagation(),T())},!0),window.openImageLightbox=w,window.closeImageLightbox=T,window.isImageLightboxOpen=C)}a(`student`);function D(){return window.matchMedia(`(hover: none) and (pointer: coarse)`).matches}function O(e){return e||(D()?`auto`:`smooth`)}function k(e,t){window.scrollTo({top:Math.max(0,e),behavior:O(t)})}var A=new Set([`card_view`,`detail_open`,`link_click`,`pdf_open`,`share_click`,`category_click`,`resource_open`]);function j(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function M(){let e=navigator.userAgent;return/(tablet|ipad|playbook|silk)|(android(?!.*mobi))/i.test(e)?`tablet`:/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Kindle|Silk-Accelerated|(hpw|web)OS|Opera M(obi|ini)/i.test(e)?`mobile`:`desktop`}function N(t,n={}){if(!A.has(t)||y===void 0)return Promise.resolve();let i={action:t,createdAt:p(),dayKey:j(),source:`student`,device:M(),contentType:n.contentType||(t===`category_click`?`category`:`post`)};return n.postId&&(i.postId=String(n.postId).slice(0,160)),n.category&&(i.category=String(n.category).slice(0,80)),r(e(y,`analyticsEvents`),i).catch(e=>{console.debug(`Student analytics skipped:`,e&&e.code?e.code:e)})}window.trackStudentEvent=N;var P=[];function F(e){return[...P,...e||[]]}var I={immigration:{labelEn:`Immigration`,labelEs:`Inmigración`,icon:`globe`,color:`#0d9488`},jobs:{labelEn:`Jobs`,labelEs:`Empleos`,icon:`briefcase`,color:`#24498f`},housing:{labelEn:`Housing`,labelEs:`Vivienda`,icon:`home`,color:`#df6b4a`},health:{labelEn:`Health`,labelEs:`Salud`,icon:`heart`,color:`#df477f`},food:{labelEn:`Food`,labelEs:`Comida`,icon:`food`,color:`#2f934f`},family:{labelEn:`Child Care`,labelEs:`Cuidado de niños`,icon:`family`,color:`#c99035`},esol:{labelEn:`English class`,labelEs:`Inglés`,icon:`abc`,color:`#8050d1`},hse:{labelEn:`GED / HSE`,labelEs:`Equivalencia escolar`,icon:`abc`,color:`#2563eb`},college:{labelEn:`College & Careers`,labelEs:`Universidad y carreras`,icon:`graduation`,color:`#0a1d3a`},"legal-aid":{labelEn:`Legal Help`,labelEs:`Ayuda legal`,icon:`scale`,color:`#7c3aed`},money:{labelEn:`Financial Help`,labelEs:`Ayuda financiera`,icon:`money`,color:`#1fa77e`},announcement:{labelEn:`Announcements`,labelEs:`Anuncios`,icon:`megaphone`,color:`#317dea`}},L=[`immigration`,`jobs`,`housing`,`health`,`food`],R=[`immigration`,`jobs`,`housing`,`health`,`food`,`family`,`hse`,`college`,`legal-aid`,`money`],z={"baby supplies":`Artículos para bebés`,"basic needs":`Necesidades básicas`,"cash assistance":`Ayuda en efectivo`,childcare:`Cuidado infantil`,"citizenship help":`Ayuda con ciudadanía`,clothing:`Ropa`,college:`Universidad`,"community help":`Ayuda comunitaria`,"credential evaluation":`Evaluación de credenciales`,"crisis hotline":`Línea de crisis`,"crisis support":`Apoyo en crisis`,"dental care":`Atención dental`,"document translation":`Traducción de documentos`,"emergency food pantry":`Despensa de emergencia`,"english classes":`Clases de inglés`,essentials:`Artículos esenciales`,"family help":`Ayuda familiar`,"family programs":`Programas familiares`,"family resource center":`Centro de recursos familiares`,"family shelter":`Refugio familiar`,"family support":`Apoyo familiar`,"find legal help":`Encuentre ayuda legal`,"find a clinic":`Encuentre una clínica`,"food benefits":`Beneficios de alimentos`,"food help":`Ayuda alimentaria`,"food hotline":`Línea de alimentos`,"food pantry":`Despensa de alimentos`,"free diapers":`Pañales gratis`,"free food":`Comida gratis`,"fuel help":`Ayuda con calefacción`,"grocery bags":`Bolsas de comestibles`,"health care":`Atención médica`,"health insurance help":`Ayuda con seguro médico`,"hot meals":`Comidas calientes`,"housing help":`Ayuda con vivienda`,"immigrant support":`Apoyo a inmigrantes`,"immigration help":`Ayuda con inmigración`,"job training":`Capacitación laboral`,"legal help":`Ayuda legal`,"legal information":`Información legal`,"low cost produce":`Productos a bajo costo`,"mobile food pantry":`Despensa móvil`,"parent support":`Apoyo a padres`,preschool:`Preescolar`,"public housing":`Vivienda pública`,"refugee support":`Apoyo a refugiados`,"rent help":`Ayuda con renta`,"snap help":`Ayuda con SNAP`,"tax help":`Ayuda con impuestos`,"tenant rights":`Derechos del inquilino`,"trauma support":`Apoyo en trauma`,"unemployment help":`Ayuda con desempleo`,"utility help":`Ayuda con servicios`,"wic help":`Ayuda con WIC`,"worker rights":`Derechos del trabajador`};function B(e){let t=String(e||``).trim();return t?z[t.toLowerCase()]||t:``}var V={all:{icon:`✨`,title:`Main Feed`,description:`New help, classes, jobs, and community support from your advisors.`,chips:[`New`,`Free help`,`This week`]},housing:{icon:`🏠`,title:`Housing Help`,description:`Find apartments, shelters, rent help, and housing support.`,chips:[`Emergency Housing`,`Apartments`,`Rent Help`,`Tenant Rights`]},job:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},jobs:{icon:`💼`,title:`Job Posts`,description:`See advisor posts about job openings, hiring notices, resumes, and career support.`,chips:[`Hiring Now`,`Resume Help`,`Career Support`]},immigration:{icon:`🌎`,title:`Immigration Help`,description:`Find legal help, citizenship support, and trusted local organizations.`,chips:[`Citizenship`,`Legal Help`,`Know Your Rights`,`Green Card`]},health:{icon:`❤️`,title:`Health Support`,description:`Find clinics, health information, mental health support, and care nearby.`,chips:[`Clinics`,`Mental Health`,`Insurance`,`Urgent Help`]},food:{icon:`🥕`,title:`Food Help`,description:`Find food pantries, meal programs, and grocery help for families.`,chips:[`Food Pantry`,`Meals`,`Delivery`,`Family Help`]},esol:{icon:`📘`,title:`Free Classes`,description:`Find English classes, adult education, GED, and student support.`,chips:[`English Class`,`GED`,`Conversation`,`Career English`]},college:{icon:`🎓`,title:`College Pathways`,description:`Find college, GED, certificates, and next-step education support.`,chips:[`GED`,`Certificates`,`Financial Aid`,`College Help`]},money:{icon:`💵`,title:`Money Help`,description:`Find financial coaching, benefits, tax help, and low-cost support.`,chips:[`Benefits`,`Tax Help`,`Budgeting`,`Free Support`]},childcare:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},family:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent help.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},training:{icon:`🧰`,title:`Training Posts`,description:`See advisor posts about workshops, skills training, certificates, and programs.`,chips:[`Workshops`,`Certificates`,`Career Skills`,`Programs`]},"career-fair":{icon:`📍`,title:`Career Fairs`,description:`Find hiring events, job fairs, and places to meet employers.`,chips:[`Hiring Events`,`Employers`,`Resume`,`Interviews`]},announcement:{icon:`📢`,title:`Announcements`,description:`School news, reminders, and general updates from your advisors.`,chips:[`School News`,`Reminders`,`Updates`,`Events`]}},H={shield:`
    ...
    `},U=class r{constructor(){this.currentUser=null,this.bulletins=[],this.filteredPosts=[],this.lastHashHighlight=null,this.currentView=`feed`,this.currentFeedCategory=`all`,this.currentResourceCategory=`all`,this.currentDesktopResourceTopic=`all`,this.expandedDesktopResourceSections=new Set,this.mobileResourceCategoryReturnView=`categories`,this.resourceSearchQuery=``,this.resourceSortMode=`default`,this.datesViewMode=`list`,this.isSearchLayerOpen=!1,this.trackedCardViews=new Set,this.activeDetailBulletinId=null,this.handleHashChange=this.handleHashRouting.bind(this),this.handleDescriptionToggle=this.handleDescriptionToggle.bind(this),this.init()}init(){this.currentCalendarMonth=new Date().getMonth(),this.currentCalendarYear=new Date().getFullYear(),this.bindEvents(),this.loadBulletins(),this.checkAutoLogin(),this.setupRealtimeListener(),this.switchView(`feed`,{skipRender:!0,preserveDetail:!0}),this.closeSearchLayer({preserveScroll:!0,silent:!0}),window.addEventListener(`hashchange`,this.handleHashChange)}static CACHE_KEY=`ebhcs_bulletins_v1`;static CACHE_TTL=1800*1e3;_readCache(){try{let e=sessionStorage.getItem(r.CACHE_KEY);if(!e)return null;let{ts:t,bulletins:n}=JSON.parse(e);return Date.now()-t>r.CACHE_TTL?null:n}catch{return null}}_writeCache(e){try{sessionStorage.setItem(r.CACHE_KEY,JSON.stringify({ts:Date.now(),bulletins:e}))}catch{}}setupRealtimeListener(){let r=this._readCache();r&&r.length>0&&(this.bulletins=r,this.populateAdvisorFilters(),this.renderResourceCategoryFilters(),this.displayBulletins()),n(b(e(y,`bulletins`),t(`isActive`,`==`,!0),i(`datePosted`,`desc`)),e=>{this.bulletins=[],e.forEach(e=>{this.bulletins.push({id:e.id,...this.normalizeBulletin(e.data())})}),this._writeCache(this.bulletins),this.populateAdvisorFilters(),this.renderResourceCategoryFilters(),this.displayBulletins()},e=>{console.error(`Error loading bulletins:`,e);let t=document.getElementById(`bulletinGrid`);t&&(t.innerHTML=`<div class="feed-load-error" role="alert"><p>Could not load posts. Check your connection and try again.</p><p class="empty-state-bilingual">No se pudieron cargar las publicaciones. Comprueba tu conexión.</p></div>`)})}normalizeBulletin(e){let t=e.type||`post`,n={...e,type:t};if(t===`resource`&&(n.isPublished=e.isPublished!==!1),n.dateType===`sessions`){let t=e.startTime||``,r=e.endTime||``;Array.isArray(e.eventDates)&&e.eventDates.length?n.eventDates=s(e.eventDates,t,r):e.eventDate?n.eventDates=s([e.eventDate],t,r):n.eventDates=[],n.eventDate=n.eventDates[0]?.date||e.eventDate||``}return n}getBulletinEventSessions(e){if(!e||e.dateType!==`sessions`)return[];let t=e.startTime||``,n=e.endTime||``;return Array.isArray(e.eventDates)&&e.eventDates.length?s(e.eventDates,t,n):e.eventDate?s([e.eventDate],t,n):[]}getBulletinEventDates(e){return e?e.dateType===`sessions`?this.getBulletinEventSessions(e).map(e=>e.date):e.eventDate?[String(e.eventDate).split(`T`)[0]]:e.startDate?[String(e.startDate).split(`T`)[0]]:e.deadline?[String(e.deadline).split(`T`)[0]]:[]:[]}formatEventDatesDisplay(e){if(e.dateType===`sessions`){let t=this.getBulletinEventSessions(e);if(!t.length)return null;if(t.length===1){let n=this.parseDateOnly(t[0].date);return n?this.getDatesListLabel(e,n,`event`,{session:t[0]}):null}let n=this.getLocale(),r=t.map(e=>{let t=this.parseStoredYmdLocal(e.date),r=t?t.toLocaleDateString(n,{weekday:`short`,month:`short`,day:`numeric`}):e.date,i=this.formatTimeRange(e.startTime,e.endTime);return i?`${r} · ${i}`:r});return r.length===2?`${r[0]} & ${r[1]}`:this.getCurrentLang()===`ES`?`${r.length} sesiones`:`${r.length} sessions`}let t=this.getDatesListItem(e);return t?t.label:null}isApplicationDeadline(e){if(e.dateType===`deadline`){let t=e.eventDate||e.deadline;return t?this.isDeadlineClose(t):!1}return!e.dateType&&e.deadline&&!e.eventDate&&!e.startDate?this.isDeadlineClose(e.deadline):!1}formatStartDateLabelHtml(e,t){let n=this.getLocale(),r=this.getCurrentLang()===`ES`,i=e.toLocaleDateString(n,{weekday:`short`,month:`short`,day:`numeric`}),a=e.toLocaleDateString(n,{weekday:`long`,month:`short`,day:`numeric`}),o=this.formatTimeRange(t.startTime,t.endTime),s=o?` · ${this.escapeHtml(o)}`:``,c=r?`Comienza el`:`Starts`,l=r?a:i;return`<strong class="date-label-prefix">${this.escapeHtml(c)}</strong> ${this.escapeHtml(l)}${s}`}formatFeedDateDisplayHtml(e){if(e.dateType===`sessions`){let t=this.formatEventDatesDisplay(e);return t?this.escapeHtml(t):``}let t=this.getDatesListItem(e);return t?t.kind===`start`?this.formatStartDateLabelHtml(t.date,e):this.escapeHtml(t.label):``}formatSessionDatesDetailLabel(e){let t=this.getBulletinEventSessions(e);if(!t.length)return``;if(t.length===1){let e=t[0],n=this.parseStoredYmdLocal(e.date),r=n?n.toLocaleDateString(`en-US`,{weekday:`long`,month:`short`,day:`numeric`}):e.date,i=this.formatTimeRange(e.startTime,e.endTime);return i?`${r} · ${i}`:r}let n=d(t)?this.formatTimeRange(t[0].startTime,t[0].endTime):``;return n?`${t.length} sessions · ${n}`:`${t.length} sessions`}buildSessionDatesDetailHtml(e){let t=this.getBulletinEventSessions(e);if(!t.length)return``;let n=e=>{let t=this.parseStoredYmdLocal(e);return t?t.toLocaleDateString(`en-US`,{weekday:`long`,month:`short`,day:`numeric`}):e};if(t.length===1){let e=t[0],r=this.formatTimeRange(e.startTime,e.endTime),i=r?`${n(e.date)} · ${r}`:n(e.date);return`<small>${this.escapeHtml(i)}</small>`}let r=d(t),i=r?this.formatTimeRange(t[0].startTime,t[0].endTime):``,a=t.map(e=>{let t=n(e.date);if(r)return`<li>${this.escapeHtml(t)}</li>`;let i=this.formatTimeRange(e.startTime,e.endTime);return i?`<li><span class="post-detail-session-date">${this.escapeHtml(t)}</span><span class="post-detail-session-time">${this.escapeHtml(i)}</span></li>`:`<li>${this.escapeHtml(t)}</li>`}).join(``);return`
        ...
        `}updateSearchLayerCatState(e){let t=this.normalizeFeedCategory(e);document.querySelectorAll(`.sl-cat-btn[data-cat-filter]`).forEach(e=>{let n=e.getAttribute(`data-cat-filter`),r=n===`all`?t===`all`:this.normalizeFeedCategory(n)===t;e.classList.toggle(`active`,r)})}updateActiveCategoryState(){let e=this.currentFeedCategory||`all`;document.querySelectorAll(`.cat-chip[data-cat-filter]`).forEach(t=>{let n=this.normalizeFeedCategory(t.getAttribute(`data-cat-filter`)||`all`);t.classList.toggle(`active`,n===e||e===`all`&&n===`all`)}),document.querySelectorAll(`.story-bubble[data-app-view-cat]`).forEach(t=>{let n=this.normalizeFeedCategory(t.getAttribute(`data-app-view-cat`)||`all`);t.classList.toggle(`active`,n===e),t.setAttribute(`aria-pressed`,String(n===e))})}toggleSearchLayer(){this.isSearchLayerOpen?this.closeSearchLayer():this.openSearchLayer()}openSearchLayer(){this.currentView!==`feed`&&this.switchView(`feed`,{skipRender:!0,preserveDetail:!0}),this.isSearchLayerOpen=!0;let e=document.getElementById(`searchLayer`);e&&(e.classList.add(`open`),e.setAttribute(`aria-hidden`,`false`)),document.body.classList.add(`search-layer-open`),this.syncHeaderSearchButton(),window.matchMedia(`(max-width: 768px)`).matches&&window.setTimeout(()=>{document.getElementById(`searchInput`)?.focus()},180)}closeSearchLayer(e={}){this.isSearchLayerOpen=!1;let t=document.getElementById(`searchLayer`);t&&(t.classList.remove(`open`),t.setAttribute(`aria-hidden`,`true`)),document.body.classList.remove(`search-layer-open`),e.silent||this.syncHeaderSearchButton()}syncHeaderSearchButton(){let e=document.getElementById(`mobileSearchTrigger`);if(!e)return;let t=this.currentView===`feed`||this.currentView===`resources`;e.hidden=!t;let n=this.currentView===`resources`?this.resourceSearchQuery&&this.resourceSearchQuery.trim()!==``:this.areFiltersApplied();e.classList.toggle(`active`,t&&(this.isSearchLayerOpen||n)),e.setAttribute(`aria-expanded`,t&&this.isSearchLayerOpen?`true`:`false`)}setLanguage(e){let t=e===`ES`?`ES`:`EN`;document.body.setAttribute(`data-lang`,t),document.documentElement.setAttribute(`data-lang`,t),document.querySelectorAll(`[data-lang-switch]`).forEach(e=>{e.classList.toggle(`active`,e.getAttribute(`data-lang-switch`)===t)}),this.updateSearchPlaceholder(),this.currentView===`resources`?this.renderResourcesSections(this.getPublishedResources()):this.applyFilters();let n=document.getElementById(`bulletinDetailModal`);this.activeDetailBulletinId&&n?.style.display===`flex`&&this.showBulletinDetail(this.activeDetailBulletinId)}updateSearchPlaceholder(){let e=document.getElementById(`searchInput`),t=document.getElementById(`desktopTopbarSearchInput`),n=document.getElementById(`mobileInlineSearchInput`),r=document.body.getAttribute(`data-lang`)===`ES`,i=this.currentView===`resources`,a=i?r?`Busca ayuda...`:`Search help...`:r?`Busca ayuda, anuncios y eventos...`:`Search for help, announcements, and events...`,o=i?r?`Busca ayuda...`:`Search help...`:r?`¿Con qué necesitas ayuda?`:`What do you need help with?`;t&&(t.placeholder=a),[e,n].filter(Boolean).forEach(e=>{e.placeholder=o})}renderFeed(e){let t=document.getElementById(`bulletinGrid`),n=document.getElementById(`feedEmptyState`);if(!(!t||!n)){if(e.length===0){t.innerHTML=``,n.innerHTML=this.areFiltersApplied()?`<h3>No bulletins found</h3><p>Try adjusting your search or filter criteria.</p>`:`<h3>No bulletins posted yet</h3><p>Advisors can log in to post job opportunities, training sessions, and important announcements.</p>`,n.style.display=`block`;return}n.style.display=`none`,t.innerHTML=e.map(e=>this.createBulletinCard(e)).join(``),this.trackRenderedCardViews(e)}}trackRenderedCardViews(e){e.forEach(e=>{!e.id||this.trackedCardViews.has(e.id)||(this.trackedCardViews.add(e.id),N(`card_view`,{postId:e.id,category:e.category,contentType:e.type||`post`}))})}renderCalendar(e){let t=document.getElementById(`bulletinCalendar`),n=document.getElementById(`calendarEmptyState`),r=document.getElementById(`bulletinCalendarDesktopGrid`);if(!t||!n)return;let i=F(e),a=i.filter(e=>this.bulletinHasCalendarDates(e));if(a.length===0){t.innerHTML=``,r&&(r.innerHTML=``),n.style.display=`block`;return}n.style.display=`none`,this.updateDatesViewToggle(),window.matchMedia(`(min-width: 1024px)`).matches?(t.innerHTML=this.createDatesListView(a),r&&(r.innerHTML=this.createCalendarView(i,{navigatorMode:!0}),this.bindCalendarDayScroll(r))):(t.innerHTML=this.datesViewMode===`calendar`?this.createCalendarView(i):this.createDatesListView(a),r&&(r.innerHTML=``))}bindCalendarDayScroll(e){e.querySelectorAll(`[data-calendar-day]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-calendar-day`);if(!t)return;let n=document.querySelector(`[data-list-date="${t}"]`);if(!n)return;let r=parseInt(getComputedStyle(document.documentElement).getPropertyValue(`--app-header-offset`)||`70`,10);k(window.scrollY+n.getBoundingClientRect().top-r-16),n.classList.add(`list-card-pulse`),setTimeout(()=>n.classList.remove(`list-card-pulse`),1400)})})}renderHomeUpcomingEvents(e){let t=document.getElementById(`homeUpcomingEvents`);if(!t)return;let n=new Date;n.setHours(0,0,0,0);let r=F(e).flatMap(e=>{if(e.dateType===`sessions`)return this.getBulletinEventDates(e).map(t=>({bulletin:e,rawDate:t,timestamp:this.getTimestampValue(t)}));let t=e.eventDate||e.startDate||e.deadline;return[{bulletin:e,rawDate:t,timestamp:this.getTimestampValue(t)}]}).filter(e=>e.timestamp&&e.timestamp>=n.getTime()).sort((e,t)=>e.timestamp-t.timestamp).slice(0,3);if(r.length===0){t.innerHTML=`<div class="side-empty">Events with dates will appear here.</div>`;return}t.innerHTML=r.map(({bulletin:e,rawDate:t,timestamp:n})=>{let r=new Date(n),i=this.getLocale(),a=r.toLocaleDateString(i,{month:`short`}).toUpperCase(),o=r.toLocaleDateString(i,{day:`numeric`}),s=[r.toLocaleDateString(i,{weekday:`long`}),e.startTime||``].filter(Boolean).join(` · `);return`
            ...
            `}).join(``)||`<p class="hero-resources-empty">No help links available yet.</p>`,t.querySelectorAll(`.hero-resource-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.resourceCategory;this.openResourceShortcut(t)})})}renderResourceStoryRow(e,t,n){let r=document.getElementById(e);if(!r)return;if(r.innerHTML=n.map(e=>this.createResourceStoryBubble(e)).join(``),!t){r.style.display=n.length>0?`flex`:`none`;return}let i=document.getElementById(t);if(!i)return;let a=n.length>0;r.style.display=a?`flex`:`none`,i.style.display=a?`none`:`block`}renderResourceCategoryFilters(){let e=document.getElementById(`resourceCategoryFilters`);if(!e)return;let t=this.getPublishedResources();e.innerHTML=R.map(e=>{let n=I[e];if(!n)return``;let r=t.filter(t=>this.getResourceCategoryKey(t)===e).length,i=H[n.icon]||H.globe,a=this.getResourceCountNoun(r,`en`),o=this.getResourceCountNoun(r,`es`);return`
            <button
                type="button"
        ...
        `}).join(``)}renderResourceCategoryDetailHeader(e){let t=document.getElementById(`resourceCategoryDetail`),n=document.getElementById(`resourceCategoryFilters`);if(!t)return;let r=this.currentResourceCategory,i=r&&r!==`all`?I[r]:null,a=window.matchMedia(`(max-width: 767px)`).matches;if(!e||!i||!a){t.hidden=!0,t.style.display=`none`,t.innerHTML=``,n&&(n.hidden=!1,n.style.removeProperty(`display`)),document.body.classList.remove(`resource-category-detail-open`);return}document.body.classList.add(`resource-category-detail-open`);let o=this.getPublishedResources().filter(e=>this.resourceMatchesCategory(e,r)),s=H[i.icon]||H.globe;t.hidden=!1,t.style.removeProperty(`display`),n&&(n.hidden=!0,n.style.display=`none`),t.style.setProperty(`--cat-accent`,i.color);let c=this.mobileResourceCategoryReturnView===`feed`;t.innerHTML=`
        ...
        `+R.map(e=>{let t=I[e];if(!t)return``;let n=(o[e]||[]).length,r=H[t.icon]||H.globe;return`
                <button
                    type="button"
            ...
            `}).join(``);let c=e=>{this.currentDesktopResourceTopic=e||`all`,t.querySelectorAll(`.desktop-cat-btn`).forEach(e=>{let t=e.dataset.desktopCat||`all`;e.classList.toggle(`active`,t===this.currentDesktopResourceTopic)})};t.querySelectorAll(`.desktop-cat-btn`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.desktopCat;if(!t)return;c(t);let r=parseInt(getComputedStyle(document.documentElement).getPropertyValue(`--app-header-offset`)||`70`,10);if(t===`all`){let e=n.closest(`.resources-desktop-main`)||n;k(window.scrollY+e.getBoundingClientRect().top-r-16);return}let i=document.getElementById(`desktop-section-${t}`);i&&k(window.scrollY+i.getBoundingClientRect().top-r-16)})});let l=R.filter(e=>(o[e]||[]).length>0);if(l.length===0){n.innerHTML=``,r&&(r.style.display=`block`);return}r&&(r.style.display=`none`),n.innerHTML=l.map(e=>{let t=I[e];if(!t)return``;let n=o[e],r=H[t.icon]||H.globe,i=n.map(e=>this.createHelpResourceCard(e,t)).join(``);return`
    ...
    <article class="pc ${r?`pc--expired`:``}" id="bulletin-${e.id}" data-bulletin-id="${e.id}" onclick="${u}" role="button" tabindex="0" style="cursor:pointer">
      ...
      <div class="pc__body">
        ...
        `}formatRichText(e){let t=document.createElement(`div`);return t.textContent=e||``,this.applyInlineFormatting(t.innerHTML)}applyInlineFormatting(e){return g(e).replace(/`(.+?)`/g,`<code>$1</code>`)}handleDescriptionToggle(e){let t=e.target.closest(`.toggle-description`);if(!t)return;let n=t.getAttribute(`data-bulletin`);n&&this.showBulletinDetail(n)}renderDateInfo(e){if(e.dateType&&(e.eventDate||e.eventDates&&e.eventDates.length||e.startDate&&e.endDate))return this.renderNewDateInfo(e);if(e.deadline){let t=this.isDeadlineClose(e.deadline);return`
            ...
            `}else if(t===`sessions`){let t=this.getBulletinEventSessions(e);t.length&&(n=`
                    <div class="meta-item">
                        ...
                        ${h(t,e=>this.formatDateLocal(e),(e,t)=>this.formatTimeRange(e,t)).map(e=>`<div>${this.escapeHtml(e)}</div>`).join(``)}
                    </div>
        ...
        `}checkAutoLogin(){}previousMonth(){this.currentCalendarMonth--,this.currentCalendarMonth<0&&(this.currentCalendarMonth=11,this.currentCalendarYear--),console.log(`📅 Previous month:`,this.currentCalendarMonth,this.currentCalendarYear),this.displayBulletins()}nextMonth(){this.currentCalendarMonth++,this.currentCalendarMonth>11&&(this.currentCalendarMonth=0,this.currentCalendarYear++),console.log(`📅 Next month:`,this.currentCalendarMonth,this.currentCalendarYear),this.displayBulletins()}};function W(e,t){if(window.bulletinBoard){let t=window.bulletinBoard.bulletins.find(t=>t.id===e);N(`share_click`,{postId:e,category:t?t.category:``,contentType:t&&t.type||`post`})}G(t,`${window.location.origin}${window.location.pathname}#bulletin-${e}`)}function G(e,t){J();let n=document.createElement(`div`);n.className=`share-modal`,n.innerHTML=`
    ...
    `,document.body.appendChild(n)}function K(e,t,n){let r={whatsapp:`https://wa.me/?text=${t}%20${n}`,facebook:`https://www.facebook.com/sharer/sharer.php?u=${n}`,email:`mailto:?subject=${t}&body=Check out this opportunity: ${n}`,sms:`sms:?body=${t} ${n}`};window.open(r[e],`_blank`),J()}function q(){let e=document.getElementById(`shareLink`);e.select(),e.setSelectionRange(0,99999);try{document.execCommand(`copy`);let e=document.querySelector(`.copy-btn`);e.textContent=`Copied!`,e.style.background=`#27ae60`,setTimeout(()=>{e.textContent=`Copy Link`,e.style.background=``},2e3)}catch(e){console.error(`Copy failed:`,e)}}function J(){let e=document.querySelector(`.share-modal`);e&&e.remove()}window.shareBulletin=W,window.shareVia=K,window.copyLink=q,window.closeShareModal=J;var Y;document.addEventListener(`DOMContentLoaded`,()=>{Y=new U,window.bulletinBoard=Y}),E();