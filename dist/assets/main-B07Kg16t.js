import{E as e,S as t,_ as n,m as r,n as i,v as a,w as o,y as s}from"./firebase-C9MMRSmU.js";var c=new Set([`card_view`,`detail_open`,`link_click`,`pdf_open`,`share_click`,`category_click`,`resource_open`]);function l(e=new Date){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function u(t,n={}){if(!c.has(t)||i===void 0)return Promise.resolve();let a={action:t,createdAt:e(),dayKey:l(),source:`student`,contentType:n.contentType||(t===`category_click`?`category`:`post`)};return n.postId&&(a.postId=String(n.postId).slice(0,160)),n.category&&(a.category=String(n.category).slice(0,80)),r(o(i,`analyticsEvents`),a).catch(e=>{console.debug(`Student analytics skipped:`,e&&e.code?e.code:e)})}window.trackStudentEvent=u;var d=[{name:`Leah`,role:`Coordinator/Educator`,username:`lgregory`},{name:`Carmen`,role:`Advisor`,username:`vlalin`},{name:`Fabiola`,role:`Advisor`,username:`fvaquerano`},{name:`Felipe`,role:`Advisor`,username:`fgallego`},{name:`Jerome`,role:`Advisor`,username:`jkiley`},{name:`Jorge`,role:`Advisor`,username:`rocha`},{name:`Leidy`,role:`Advisor`,username:`lalzate`},{name:`Mike K.`,role:`Advisor`,username:`mkelsen`},{name:`Simonetta`,role:`Advisor`,username:`spiergentili`}],f=[];function p(e){return[...f,...e||[]]}var m={immigration:{labelEn:`Immigration`,labelEs:`Inmigracion`,icon:`globe`,color:`#0d9488`},jobs:{labelEn:`Jobs`,labelEs:`Empleos`,icon:`briefcase`,color:`#24498f`},housing:{labelEn:`Housing`,labelEs:`Vivienda`,icon:`home`,color:`#df6b4a`},health:{labelEn:`Health`,labelEs:`Salud`,icon:`heart`,color:`#df477f`},food:{labelEn:`Food`,labelEs:`Comida`,icon:`food`,color:`#2f934f`},family:{labelEn:`Family`,labelEs:`Familia`,icon:`family`,color:`#c99035`},esol:{labelEn:`English class`,labelEs:`Ingles`,icon:`abc`,color:`#8050d1`},college:{labelEn:`College & GED`,labelEs:`Universidad`,icon:`graduation`,color:`#0a1d3a`},"career-fair":{labelEn:`Career Fair`,labelEs:`Feria`,icon:`handshake`,color:`#f08b1f`},money:{labelEn:`Money help`,labelEs:`Ayuda`,icon:`money`,color:`#1fa77e`},announcement:{labelEn:`Announcements`,labelEs:`Anuncios`,icon:`megaphone`,color:`#317dea`}},h=[`immigration`,`jobs`,`housing`,`health`,`food`],g=[`jobs`,`immigration`,`housing`,`health`,`food`,`family`,`esol`,`college`,`career-fair`,`money`],_={all:{icon:`✨`,title:`Main Feed`,description:`New help, classes, jobs, and community resources from your advisors.`,chips:[`New`,`Free help`,`This week`]},housing:{icon:`🏠`,title:`Housing Help`,description:`Find apartments, shelters, rent help, and housing support.`,chips:[`Emergency Housing`,`Apartments`,`Rent Help`,`Tenant Rights`]},job:{icon:`💼`,title:`Jobs Hiring Now`,description:`Find job openings, training, resumes, and career support.`,chips:[`Hiring Now`,`Training`,`Resume Help`,`Career Fair`]},jobs:{icon:`💼`,title:`Jobs Hiring Now`,description:`Find job openings, training, resumes, and career support.`,chips:[`Hiring Now`,`Training`,`Resume Help`,`Career Fair`]},immigration:{icon:`🌎`,title:`Immigration Help`,description:`Find legal help, citizenship support, and trusted local organizations.`,chips:[`Citizenship`,`Legal Help`,`Know Your Rights`,`Green Card`]},health:{icon:`❤️`,title:`Health Support`,description:`Find clinics, health information, mental health support, and care nearby.`,chips:[`Clinics`,`Mental Health`,`Insurance`,`Urgent Help`]},food:{icon:`🥕`,title:`Food Resources`,description:`Find food pantries, meal programs, and grocery help for families.`,chips:[`Food Pantry`,`Meals`,`Delivery`,`Family Help`]},esol:{icon:`📘`,title:`Free Classes`,description:`Find English classes, adult education, GED, and student support.`,chips:[`English Class`,`GED`,`Conversation`,`Career English`]},college:{icon:`🎓`,title:`College Pathways`,description:`Find college, GED, certificates, and next-step education support.`,chips:[`GED`,`Certificates`,`Financial Aid`,`College Help`]},money:{icon:`💵`,title:`Money Help`,description:`Find financial coaching, benefits, tax help, and low-cost support.`,chips:[`Benefits`,`Tax Help`,`Budgeting`,`Free Support`]},childcare:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent resources.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},family:{icon:`👨‍👩‍👧`,title:`Family Support`,description:`Find child care, family programs, youth support, and parent resources.`,chips:[`Child Care`,`Family Programs`,`Youth`,`Parent Help`]},training:{icon:`🧰`,title:`New Programs`,description:`Find skills training, certificates, and programs that can lead to work.`,chips:[`Certificate`,`Short Program`,`Career Skills`,`Free`]},"career-fair":{icon:`📍`,title:`Career Fairs`,description:`Find hiring events, job fairs, and places to meet employers.`,chips:[`Hiring Events`,`Employers`,`Resume`,`Interviews`]}},v={shield:`
